...
public class WSMenuEntry {
     ...
     * 
     */
    public WSMenuEntry(final String id, final List<WSMenuEntry.Descriptions> descriptions, final String context, final String application, final String icon, final List<WSMenuEntry> subMenus) {
        this.id = id;
    ...
    public static class Descriptions {
         ...
         * 
         */
        public Descriptions(final String language, final String label) {
