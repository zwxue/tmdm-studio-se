...
public class WSTransformerProcessStep {
     ...
     * 
     */
    public WSTransformerProcessStep(final String pluginJNDI, final String description, final String parameters, final List<WSTransformerVariablesMapping> inputMappings, final List<WSTransformerVariablesMapping> outputMappings, final Boolean disabled) {
