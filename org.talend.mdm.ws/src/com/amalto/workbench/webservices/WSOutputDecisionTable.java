...
public class WSOutputDecisionTable {
     ...
     * 
     */
    public WSOutputDecisionTable(final List<WSOutputDecisionTable.Decisions> decisions) {
    ...
    public static class Decisions {
         ...
         * 
         */
        public Decisions(final String outputVariableName, final String decision) {
