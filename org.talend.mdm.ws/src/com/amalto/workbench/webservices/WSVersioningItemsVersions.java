...
public class WSVersioningItemsVersions {
     ...
     * 
     */
    public WSVersioningItemsVersions(final List<WSVersioningItemsVersions.Items> items) {
        this.items = items;
    }
    ...
    public static class Items {
         ...
         * 
         */
        public Items(final WSItemPK wsItemPK, final List<WSVersioningHistoryEntry> wsVersionEntries) {
