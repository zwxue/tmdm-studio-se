...
public class WSBusinessTemplate {
     ...
     * 
     */
    public WSBusinessTemplate(final String name, final WSTemplateType type, final WSBusinessSimpleTemplate simpleTemplate, final WSBusinessComplexTemplate complexTemplate) {
        this.name = name;
        this.type = type;
