...
public class WSExtractUsingTransformerThruView {
     ...
     * 
     */
    public WSExtractUsingTransformerThruView(final WSDataClusterPK wsDataClusterPK, final WSTransformerPK wsTransformerPK, final WSViewPK wsViewPK, final WSWhereItem whereItem, final int spellTreshold, final int skip, final int maxItems, final String orderBy, final String direction) {
