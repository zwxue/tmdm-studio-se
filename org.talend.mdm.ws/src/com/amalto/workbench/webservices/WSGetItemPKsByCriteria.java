...
public class WSGetItemPKsByCriteria {
     ...
     * 
     */
    public WSGetItemPKsByCriteria(final WSDataClusterPK wsDataClusterPK, final String conceptName, final String contentKeywords, final String keysKeywords, final Long fromDate, final Long toDate, final int skip, final int maxItems) {
