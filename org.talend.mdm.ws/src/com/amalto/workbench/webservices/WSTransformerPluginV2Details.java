...
public class WSTransformerPluginV2Details {
     ...
     * 
     */
    public WSTransformerPluginV2Details(final List<WSTransformerPluginV2VariableDescriptor> inputVariableDescriptors, final List<WSTransformerPluginV2VariableDescriptor> outputVariableDescriptors, final String description, final String documentation, final String parametersSchema) {
