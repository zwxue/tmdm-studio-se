...
public class WSProcessFileUsingTransformerAsBackgroundJob {
     ...
     * 
     */
    public WSProcessFileUsingTransformerAsBackgroundJob(final String fileName, final String contentType, final WSTransformerPK wsTransformerPK, final WSOutputDecisionTable wsOutputDecisionTable) {
