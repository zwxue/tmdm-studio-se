...
public class WSExecuteStoredProcedure {
     ...
     * 
     */
    public WSExecuteStoredProcedure(final WSStoredProcedurePK wsStoredProcedurePK, final String revisionID, final WSDataClusterPK wsDataClusterPK, final List<String> parameters) {
