...
public class WSServiceGetDocument {
     ...
     * 
     */
    public WSServiceGetDocument(final String description, final String configure, final String document, final String configureSchema, final String defaultConfig) {
