...
public class WSUniverse {
     ...
     * 
     */
    public WSUniverse(final String name, final String description, final List<WSUniverse.XtentisObjectsRevisionIDs> xtentisObjectsRevisionIDs, final String defaultItemsRevisionID, final List<WSUniverse.ItemsRevisionIDs> itemsRevisionIDs) {
        this.name = name;
    ...
    public static class ItemsRevisionIDs {
         ...
         * 
         */
        public ItemsRevisionIDs(final String conceptPattern, final String revisionID) {
    ...
    public static class XtentisObjectsRevisionIDs {
         ...
         * 
         */
        public XtentisObjectsRevisionIDs() {
            super();
        }
         ...
         * 
         */
        public XtentisObjectsRevisionIDs(final String xtentisObjectName, final String revisionID) {
