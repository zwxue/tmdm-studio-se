...
public class WSBusinessElement {
     ...
     * 
     */
    public WSBusinessElement(final String name, final int minOccurs, final int maxOccurs, final String businessTemplate, final WSKey wsForeignKey, final List<WSI18NString> wsLabel, final List<WSI18NString> wsDescription) {
        this.name = name;
        this.minOccurs = minOccurs;
        this.maxOccurs = maxOccurs;
        this.businessTemplate = businessTemplate;
        this.wsForeignKey = wsForeignKey;
