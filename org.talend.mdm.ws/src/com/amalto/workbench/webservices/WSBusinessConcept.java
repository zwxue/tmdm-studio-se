...
public class WSBusinessConcept {
     ...
     * 
     */
    public WSBusinessConcept(final String name, final String businessTemplate, final WSKey wsUniqueKey, final List<WSI18NString> wsLabel, final List<WSI18NString> wsDescription) {
        this.name = name;
