...
public class WSProcessBytesUsingTransformer {
     ...
     * 
     */
    public WSProcessBytesUsingTransformer(final WSByteArray wsBytes, final String contentType, final WSTransformerPK wsTransformerPK, final WSOutputDecisionTable wsOutputDecisionTable) {
