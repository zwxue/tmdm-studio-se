...
public class WSRole  implements java.io.Serializable {
    ...
    private urn_com_amalto_xtentis_webservice.WSRoleSpecification[] specification;
    ...
    public WSRole(
           ...
           urn_com_amalto_xtentis_webservice.WSRoleSpecification[] specification) {
           this.name = name;
     ...
     */
    public urn_com_amalto_xtentis_webservice.WSRoleSpecification[] getSpecification() {
        return specification;
    }
     ...
     * @param specification
     */
    public void setSpecification(urn_com_amalto_xtentis_webservice.WSRoleSpecification[] specification) {
        this.specification = specification;
    }

    public urn_com_amalto_xtentis_webservice.WSRoleSpecification getSpecification(int i) {
        return this.specification[i];
    }

    public void setSpecification(int i, urn_com_amalto_xtentis_webservice.WSRoleSpecification _value) {
