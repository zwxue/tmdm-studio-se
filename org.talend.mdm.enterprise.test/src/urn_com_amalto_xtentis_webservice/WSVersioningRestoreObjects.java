/**
 * WSVersioningRestoreObjects.java
 *
...
/**
 * Restore one or more Xtentis Object instances - do not pass any
 * name to restore all the instances of that object
 * 				Restoring a data cluster restores all the items in it
 */
public class WSVersioningRestoreObjects  implements java.io.Serializable {
    ...
    /**
     * Gets the versioningSystemName value for this WSVersioningRestoreObjects.
     * 
    ...
    /**
     * Sets the versioningSystemName value for this WSVersioningRestoreObjects.
     * 
    ...
    /**
     * Gets the tag value for this WSVersioningRestoreObjects.
     * 
     * @return tag
     */
    ...
    /**
     * Sets the tag value for this WSVersioningRestoreObjects.
     * 
     * @param tag
     */
    ...
    /**
     * Gets the type value for this WSVersioningRestoreObjects.
     * 
     * @return type
     */
    ...
    /**
     * Sets the type value for this WSVersioningRestoreObjects.
     * 
     * @param type
     */
    ...
    /**
     * Gets the names value for this WSVersioningRestoreObjects.
     * 
     * @return names
     */
    ...
    /**
     * Sets the names value for this WSVersioningRestoreObjects.
     * 
     * @param names
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSVersioningRestoreObjects)) return false;
        WSVersioningRestoreObjects other = (WSVersioningRestoreObjects) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSVersioningRestoreObjects.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSVersioningRestoreObjects"));
