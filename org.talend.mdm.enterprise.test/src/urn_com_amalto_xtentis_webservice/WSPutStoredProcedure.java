...
public class WSPutStoredProcedure  implements java.io.Serializable {
    private urn_com_amalto_xtentis_webservice.WSStoredProcedure wsStoredProcedure;

    public WSPutStoredProcedure() {
    }

    public WSPutStoredProcedure(
           urn_com_amalto_xtentis_webservice.WSStoredProcedure wsStoredProcedure) {
     ...
     */
    public urn_com_amalto_xtentis_webservice.WSStoredProcedure getWsStoredProcedure() {
        return wsStoredProcedure;
    }
     ...
     */
    public void setWsStoredProcedure(urn_com_amalto_xtentis_webservice.WSStoredProcedure wsStoredProcedure) {
        this.wsStoredProcedure = wsStoredProcedure;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSPutStoredProcedure"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSStoredProcedure"));
