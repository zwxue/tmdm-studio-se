 ...
 */
public class WSLoadDroppedItem  implements java.io.Serializable {
    ...
    /**
     * Gets the wsDroppedItemPK value for this WSLoadDroppedItem.
     * 
    ...
    /**
     * Sets the wsDroppedItemPK value for this WSLoadDroppedItem.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSLoadDroppedItem)) return false;
        WSLoadDroppedItem other = (WSLoadDroppedItem) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSLoadDroppedItem.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSLoadDroppedItem"));
