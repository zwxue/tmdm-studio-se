...
amalto.SynchronizationPlan.SynchronizationPlan = function(){
    ...
    var store = new Ext.data.SimpleStore({
        fields: ['filename'],
        data : [['targetOrder.xml'],['sourceOrder.xml'],['employee.xml']] // from
																			// states.js
    });    
    // The action
    ...
    var targetTree = new Tree.TreePanel({              
        ...
        autoScroll:true,
        rootVisible: true,
        root: new Ext.tree.AsyncTreeNode({text:'Order'}),
    ...
    var combo = new Ext.form.ComboBox({
        ...
        listeners:{
        	'select': function(){
        		...
        		var fileName=combo.getValue().trim();
        		if(fileName.length>0){
				    sourceTree.loader.dataUrl=Sync_dir+fileName;		
