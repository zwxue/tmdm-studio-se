...
public class XtentisPort_Stub
    ...
    private static final int existsItem_OPCODE = 4;
    private static final int existsMenu_OPCODE = 5;
    private static final int getMenu_OPCODE = 6;
    private static final int existsView_OPCODE = 7;
    private static final int putStoredProcedure_OPCODE = 8;
    private static final int deleteStoredProcedure_OPCODE = 9;
    private static final int putRole_OPCODE = 10;
    private static final int versioningRestoreObjects_OPCODE = 11;
    private static final int deleteRole_OPCODE = 12;
    private static final int getDataClusterPKs_OPCODE = 13;
    private static final int getTransformerPluginV2sList_OPCODE = 14;
    private static final int putUniverse_OPCODE = 15;
    private static final int existsTransformer_OPCODE = 16;
    private static final int existsRoutingOrderV2_OPCODE = 17;
    private static final int getStoredProcedurePKs_OPCODE = 18;
    private static final int getDataModelPKs_OPCODE = 19;
    private static final int getTransformerPKs_OPCODE = 20;
    private static final int putDataModel_OPCODE = 21;
    private static final int getDataModel_OPCODE = 22;
    private static final int versioningGetItemsHistory_OPCODE = 23;
    private static final int runQuery_OPCODE = 24;
    private static final int putBusinessConcept_OPCODE = 25;
    private static final int existsStoredProcedure_OPCODE = 26;
    private static final int getUniverse_OPCODE = 27;
    private static final int existsRoutingRule_OPCODE = 28;
    private static final int getObjectsForUniverses_OPCODE = 29;
    private static final int existsUniverse_OPCODE = 30;
    private static final int getComponentVersion_OPCODE = 31;
    private static final int existsDataModel_OPCODE = 32;
