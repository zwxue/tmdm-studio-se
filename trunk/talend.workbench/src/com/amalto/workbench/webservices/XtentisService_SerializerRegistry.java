...
public class XtentisService_SerializerRegistry implements SerializerConstants {
    ...
    public TypeMappingRegistry getRegistry() {
        ...
        {
            QName type = new QName("urn-com-amalto-xtentis-webservice", "WSGetAlgorithmsForSynchronizationPlans");
            CombinedSerializer serializer = new com.amalto.workbench.webservices.WSGetAlgorithmsForSynchronizationPlans_LiteralSerializer(type, "", DONT_ENCODE_TYPE);
            registerSerializer(mapping2,com.amalto.workbench.webservices.WSGetAlgorithmsForSynchronizationPlans.class, type, serializer);
        }
        {
