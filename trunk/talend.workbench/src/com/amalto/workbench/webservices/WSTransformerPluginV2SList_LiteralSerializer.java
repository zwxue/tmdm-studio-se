...
public class WSTransformerPluginV2SList_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSTransformerPluginV2SListItem_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.workbench.webservices.WSTransformerPluginV2SListItem.class, ns2_WSTransformerPluginV2sList$2d$Item_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSTransformerPluginV2SList instance = new com.amalto.workbench.webservices.WSTransformerPluginV2SList();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_Item_QNAME))) {
            ...
            member = new com.amalto.workbench.webservices.WSTransformerPluginV2SListItem[values.size()];
            member = values.toArray((Object[]) member);
            instance.setItem((com.amalto.workbench.webservices.WSTransformerPluginV2SListItem[])member);
        }
        else {
            instance.setItem(new com.amalto.workbench.webservices.WSTransformerPluginV2SListItem[0]);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSTransformerPluginV2SList instance = (com.amalto.workbench.webservices.WSTransformerPluginV2SList)obj;
