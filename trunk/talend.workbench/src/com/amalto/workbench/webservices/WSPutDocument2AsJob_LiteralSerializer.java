...
public class WSPutDocument2AsJob_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    private static final QName ns1_partialMapXpath_QNAME = new QName("", "partialMapXpath");
    private static final QName ns1_partialMapKey_QNAME = new QName("", "partialMapKey");
    
    public WSPutDocument2AsJob_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSPutDocument2AsJob_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.workbench.webservices.WSPutDocument2AsJob instance = new com.amalto.workbench.webservices.WSPutDocument2AsJob();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_partialMapXpath_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_partialMapXpath_QNAME, reader, context);
                instance.setPartialMapXpath((java.lang.String)member);
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_partialMapKey_QNAME))) {
            values = new ArrayList();
            for(;;) {
                elementName = reader.getName();
                if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_partialMapKey_QNAME))) {
                    value = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_partialMapKey_QNAME, reader, context);
                    values.add(value);
                    reader.nextElementContent();
                } else {
                    break;
            ...
            instance.setPartialMapKey((java.lang.String[])member);
        }
        else {
            instance.setPartialMapKey(new java.lang.String[0]);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSPutDocument2AsJob instance = (com.amalto.workbench.webservices.WSPutDocument2AsJob)obj;
    ...
    public void doSerialize(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getPartialMapXpath(), ns1_partialMapXpath_QNAME, null, writer, context);
        if (instance.getPartialMapKey() != null) {
            for (int i = 0; i < instance.getPartialMapKey().length; ++i) {
                ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getPartialMapKey()[i], ns1_partialMapKey_QNAME, null, writer, context);
            }
        }
    }
}
