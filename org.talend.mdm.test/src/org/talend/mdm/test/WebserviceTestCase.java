...
public class WebserviceTestCase extends MDMTestCase {
	...
	protected static final String PASSWORD = "administrator";
	...
	protected static final String BUSINESSCONCEPTSCHEMA = "<Country><isoCode>9999</isoCode><label>label</label><Continent>Continent</Continent></Country>";
