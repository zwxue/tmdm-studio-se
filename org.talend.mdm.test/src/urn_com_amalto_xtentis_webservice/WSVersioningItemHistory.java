...
public class WSVersioningItemHistory  implements java.io.Serializable {
    ...
    private urn_com_amalto_xtentis_webservice.WSVersioningHistoryEntry[] wsHistoryEntries;
    ...
    public WSVersioningItemHistory(
           ...
           urn_com_amalto_xtentis_webservice.WSVersioningHistoryEntry[] wsHistoryEntries) {
     ...
     */
    public urn_com_amalto_xtentis_webservice.WSVersioningHistoryEntry[] getWsHistoryEntries() {
        return wsHistoryEntries;
    }
     ...
     */
    public void setWsHistoryEntries(urn_com_amalto_xtentis_webservice.WSVersioningHistoryEntry[] wsHistoryEntries) {
        this.wsHistoryEntries = wsHistoryEntries;
    }

    public urn_com_amalto_xtentis_webservice.WSVersioningHistoryEntry getWsHistoryEntries(int i) {
        return this.wsHistoryEntries[i];
    }

    public void setWsHistoryEntries(int i, urn_com_amalto_xtentis_webservice.WSVersioningHistoryEntry _value) {
