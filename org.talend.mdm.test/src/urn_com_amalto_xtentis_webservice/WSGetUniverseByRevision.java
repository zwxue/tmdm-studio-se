...
public class WSGetUniverseByRevision  implements java.io.Serializable {
    ...
    private urn_com_amalto_xtentis_webservice.WSGetUniverseByRevisionType type;
    ...
    public WSGetUniverseByRevision(
           ...
           urn_com_amalto_xtentis_webservice.WSGetUniverseByRevisionType type) {
     ...
     * @return type
     */
    public urn_com_amalto_xtentis_webservice.WSGetUniverseByRevisionType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(urn_com_amalto_xtentis_webservice.WSGetUniverseByRevisionType type) {
        this.type = type;
    }
