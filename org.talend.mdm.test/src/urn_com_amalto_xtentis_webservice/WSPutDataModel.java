...
public class WSPutDataModel  implements java.io.Serializable {
    private urn_com_amalto_xtentis_webservice.WSDataModel wsDataModel;

    public WSPutDataModel() {
    }

    public WSPutDataModel(
           urn_com_amalto_xtentis_webservice.WSDataModel wsDataModel) {
     ...
     * @return wsDataModel
     */
    public urn_com_amalto_xtentis_webservice.WSDataModel getWsDataModel() {
        return wsDataModel;
    }
     ...
     * @param wsDataModel
     */
    public void setWsDataModel(urn_com_amalto_xtentis_webservice.WSDataModel wsDataModel) {
        this.wsDataModel = wsDataModel;
    }
