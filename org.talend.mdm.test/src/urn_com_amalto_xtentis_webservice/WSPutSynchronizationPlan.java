...
public class WSPutSynchronizationPlan  implements java.io.Serializable {
    private urn_com_amalto_xtentis_webservice.WSSynchronizationPlan wsSynchronizationPlan;

    public WSPutSynchronizationPlan() {
    }

    public WSPutSynchronizationPlan(
           urn_com_amalto_xtentis_webservice.WSSynchronizationPlan wsSynchronizationPlan) {
     ...
     */
    public urn_com_amalto_xtentis_webservice.WSSynchronizationPlan getWsSynchronizationPlan() {
        return wsSynchronizationPlan;
    }
     ...
     */
    public void setWsSynchronizationPlan(urn_com_amalto_xtentis_webservice.WSSynchronizationPlan wsSynchronizationPlan) {
        this.wsSynchronizationPlan = wsSynchronizationPlan;
    }
