...
public class WSDeleteTransformer  implements java.io.Serializable {
    ...
    /**
     * Gets the wsTransformerPK value for this WSDeleteTransformer.
     * 
    ...
    /**
     * Sets the wsTransformerPK value for this WSDeleteTransformer.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSDeleteTransformer)) return false;
        WSDeleteTransformer other = (WSDeleteTransformer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSDeleteTransformer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSDeleteTransformer"));
