...
public class WSGetSynchronizationPlan  implements java.io.Serializable {
    ...
    /**
     * Gets the wsSynchronizationPlanPK value for this WSGetSynchronizationPlan.
     * 
    ...
    /**
     * Sets the wsSynchronizationPlanPK value for this WSGetSynchronizationPlan.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSGetSynchronizationPlan)) return false;
        WSGetSynchronizationPlan other = (WSGetSynchronizationPlan) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSGetSynchronizationPlan.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSGetSynchronizationPlan"));
