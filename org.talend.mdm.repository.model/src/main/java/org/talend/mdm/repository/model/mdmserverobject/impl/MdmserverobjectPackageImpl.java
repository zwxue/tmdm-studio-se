...
public class MdmserverobjectPackageImpl extends EPackageImpl implements MdmserverobjectPackage {
	 ...
	 * @generated
	 */
	public EAttribute getWSRoleE_Recordssecurity() {
		return (EAttribute)wsRoleEEClass.getEStructuralFeatures().get(1);
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(wsRoleEEClass, WS_ROLE_E__RECORDSSECURITY);
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getWSRoleE_Recordssecurity(), ecorePackage.getEString(), "recordssecurity", null, 0, -1, WSRoleE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
