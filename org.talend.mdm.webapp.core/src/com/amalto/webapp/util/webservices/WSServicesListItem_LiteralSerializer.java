...
public class WSServicesListItem_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    private static final QName ns1_jndiName_QNAME = new QName("", "jndiName");
    private static final QName ns3_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
    private CombinedSerializer ns3_myns3_string__java_lang_String_String_Serializer;
    
    public WSServicesListItem_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSServicesListItem_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSServicesListItem instance = new com.amalto.webapp.util.webservices.WSServicesListItem();
        Object member=null;
        QName elementName;
        List values;
        Object value;
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSServicesListItem instance = (com.amalto.webapp.util.webservices.WSServicesListItem)obj;
