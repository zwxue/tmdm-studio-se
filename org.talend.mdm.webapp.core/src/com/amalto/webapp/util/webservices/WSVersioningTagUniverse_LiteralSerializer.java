...
public class WSVersioningTagUniverse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    private static final QName ns1_typeInstances_QNAME = new QName("", "typeInstances");
    ...
    public WSVersioningTagUniverse_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSVersioningTagUniverse_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
        super(type, true, encodingStyle, encodeType);
    }
    
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns3_myns3_string__java_lang_String_String_Serializer = (CombinedSerializer)registry.getSerializer("", java.lang.String.class, ns3_string_TYPE_QNAME);
        ns2_myWSLinkedHashMap_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSLinkedHashMap.class, ns2_WSLinkedHashMap_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningTagUniverse instance = new com.amalto.webapp.util.webservices.WSVersioningTagUniverse();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_typeInstances_QNAME)) {
                member = ns2_myWSLinkedHashMap_LiteralSerializer.deserialize(ns1_typeInstances_QNAME, reader, context);
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull");
                }
                instance.setTypeInstances((com.amalto.webapp.util.webservices.WSLinkedHashMap)member);
                reader.nextElementContent();
            } else {
                throw new DeserializationException("literal.unexpectedElementName", new Object[] { ns1_typeInstances_QNAME, reader.getName() });
            }
        }
        else {
            throw new DeserializationException("literal.expectedElementName", reader.getName().toString());
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningTagUniverse instance = (com.amalto.webapp.util.webservices.WSVersioningTagUniverse)obj;
    ...
    public void doSerialize(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getTypeInstances() == null) {
            throw new SerializationException("literal.unexpectedNull");
        }
        ns2_myWSLinkedHashMap_LiteralSerializer.serialize(instance.getTypeInstances(), ns1_typeInstances_QNAME, null, writer, context);
    }
}
