...
public class WSVersioningObjectsVersions_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSVersioningObjectsVersionsObjects_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSVersioningObjectsVersionsObjects.class, ns2_WSVersioningObjectsVersions$2d$objects_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningObjectsVersions instance = new com.amalto.webapp.util.webservices.WSVersioningObjectsVersions();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_objects_QNAME))) {
            ...
            member = new com.amalto.webapp.util.webservices.WSVersioningObjectsVersionsObjects[values.size()];
            member = values.toArray((Object[]) member);
            instance.setObjects((com.amalto.webapp.util.webservices.WSVersioningObjectsVersionsObjects[])member);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningObjectsVersions instance = (com.amalto.webapp.util.webservices.WSVersioningObjectsVersions)obj;
