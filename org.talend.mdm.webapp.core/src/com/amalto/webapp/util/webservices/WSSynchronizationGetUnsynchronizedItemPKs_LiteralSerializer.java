...
public class WSSynchronizationGetUnsynchronizedItemPKs_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSSynchronizationGetUnsynchronizedItemPKs instance = new com.amalto.webapp.util.webservices.WSSynchronizationGetUnsynchronizedItemPKs();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_wsDataClusterPOJOPK_QNAME)) {
                ...
                instance.setWsDataClusterPOJOPK((com.amalto.webapp.util.webservices.WSDataClusterPK)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSSynchronizationGetUnsynchronizedItemPKs instance = (com.amalto.webapp.util.webservices.WSSynchronizationGetUnsynchronizedItemPKs)obj;
