...
public class WSVersioningItemsVersionsItems_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public WSVersioningItemsVersionsItems_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSVersioningItemsVersionsItems_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSVersioningItemsVersionsItems instance = new com.amalto.webapp.util.webservices.WSVersioningItemsVersionsItems();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_wsVersionEntries_QNAME))) {
            ...
            instance.setWsVersionEntries((com.amalto.webapp.util.webservices.WSVersioningHistoryEntry[])member);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningItemsVersionsItems instance = (com.amalto.webapp.util.webservices.WSVersioningItemsVersionsItems)obj;
