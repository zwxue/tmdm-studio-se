...
public class WSProcessBytesUsingTransformerAsBackgroundJob_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSProcessBytesUsingTransformerAsBackgroundJob instance = new com.amalto.webapp.util.webservices.WSProcessBytesUsingTransformerAsBackgroundJob();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_wsBytes_QNAME)) {
                ...
                instance.setWsBytes((com.amalto.webapp.util.webservices.WSByteArray)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSProcessBytesUsingTransformerAsBackgroundJob instance = (com.amalto.webapp.util.webservices.WSProcessBytesUsingTransformerAsBackgroundJob)obj;
