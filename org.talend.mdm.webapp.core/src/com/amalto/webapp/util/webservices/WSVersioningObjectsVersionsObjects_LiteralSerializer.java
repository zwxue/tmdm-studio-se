...
public class WSVersioningObjectsVersionsObjects_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSVersioningObjectsVersionsObjects instance = new com.amalto.webapp.util.webservices.WSVersioningObjectsVersionsObjects();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_wsVersionEntries_QNAME))) {
            ...
            instance.setWsVersionEntries(new com.amalto.webapp.util.webservices.WSVersioningHistoryEntry[0]);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningObjectsVersionsObjects instance = (com.amalto.webapp.util.webservices.WSVersioningObjectsVersionsObjects)obj;
