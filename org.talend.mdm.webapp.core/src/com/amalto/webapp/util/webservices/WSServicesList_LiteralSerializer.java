...
public class WSServicesList_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSServicesListItem_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSServicesListItem.class, ns2_WSServicesList$2d$Item_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSServicesList instance = new com.amalto.webapp.util.webservices.WSServicesList();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_Item_QNAME))) {
            ...
            member = new com.amalto.webapp.util.webservices.WSServicesListItem[values.size()];
            member = values.toArray((Object[]) member);
            instance.setItem((com.amalto.webapp.util.webservices.WSServicesListItem[])member);
        }
        else {
            instance.setItem(new com.amalto.webapp.util.webservices.WSServicesListItem[0]);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSServicesList instance = (com.amalto.webapp.util.webservices.WSServicesList)obj;
