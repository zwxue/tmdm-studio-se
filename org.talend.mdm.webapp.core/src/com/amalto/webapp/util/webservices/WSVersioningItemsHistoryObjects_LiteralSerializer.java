...
public class WSVersioningItemsHistoryObjects_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public WSVersioningItemsHistoryObjects_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSVersioningItemsHistoryObjects_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns2_myWSVersioningHistoryEntry_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSVersioningHistoryEntry.class, ns2_WSVersioningHistoryEntry_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningItemsHistoryObjects instance = new com.amalto.webapp.util.webservices.WSVersioningItemsHistoryObjects();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_wsHistoryEntries_QNAME))) {
            ...
            member = new com.amalto.webapp.util.webservices.WSVersioningHistoryEntry[values.size()];
            member = values.toArray((Object[]) member);
            instance.setWsHistoryEntries((com.amalto.webapp.util.webservices.WSVersioningHistoryEntry[])member);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningItemsHistoryObjects instance = (com.amalto.webapp.util.webservices.WSVersioningItemsHistoryObjects)obj;
