...
public class WSPutTransformerV2_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSTransformerV2_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSTransformerV2.class, ns2_WSTransformerV2_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSPutTransformerV2 instance = new com.amalto.webapp.util.webservices.WSPutTransformerV2();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_wsTransformerV2_QNAME)) {
                ...
                instance.setWsTransformerV2((com.amalto.webapp.util.webservices.WSTransformerV2)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSPutTransformerV2 instance = (com.amalto.webapp.util.webservices.WSPutTransformerV2)obj;
