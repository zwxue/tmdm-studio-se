...
public class WSUniverse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns2_myWSUniverseXtentisObjectsRevisionIDs_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSUniverseXtentisObjectsRevisionIDs.class, ns2_WSUniverse$2d$xtentisObjectsRevisionIDs_TYPE_QNAME);
        ns2_myWSUniverseItemsRevisionIDs_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSUniverseItemsRevisionIDs.class, ns2_WSUniverse$2d$itemsRevisionIDs_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSUniverse instance = new com.amalto.webapp.util.webservices.WSUniverse();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_xtentisObjectsRevisionIDs_QNAME))) {
            ...
            member = new com.amalto.webapp.util.webservices.WSUniverseXtentisObjectsRevisionIDs[values.size()];
            member = values.toArray((Object[]) member);
            instance.setXtentisObjectsRevisionIDs((com.amalto.webapp.util.webservices.WSUniverseXtentisObjectsRevisionIDs[])member);
        }
        else {
            instance.setXtentisObjectsRevisionIDs(new com.amalto.webapp.util.webservices.WSUniverseXtentisObjectsRevisionIDs[0]);
        }
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_itemsRevisionIDs_QNAME))) {
            ...
            member = new com.amalto.webapp.util.webservices.WSUniverseItemsRevisionIDs[values.size()];
            member = values.toArray((Object[]) member);
            instance.setItemsRevisionIDs((com.amalto.webapp.util.webservices.WSUniverseItemsRevisionIDs[])member);
        }
        else {
            instance.setItemsRevisionIDs(new com.amalto.webapp.util.webservices.WSUniverseItemsRevisionIDs[0]);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSUniverse instance = (com.amalto.webapp.util.webservices.WSUniverse)obj;
