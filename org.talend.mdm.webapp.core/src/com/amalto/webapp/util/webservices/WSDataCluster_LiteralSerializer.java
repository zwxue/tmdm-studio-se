...
public class WSDataCluster_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    private static final QName ns1_vocabulary_QNAME = new QName("", "vocabulary");
    
    public WSDataCluster_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSDataCluster_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSDataCluster instance = new com.amalto.webapp.util.webservices.WSDataCluster();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_vocabulary_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_vocabulary_QNAME, reader, context);
                instance.setVocabulary((java.lang.String)member);
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSDataCluster instance = (com.amalto.webapp.util.webservices.WSDataCluster)obj;
    ...
    public void doSerialize(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getVocabulary(), ns1_vocabulary_QNAME, null, writer, context);
    }
}
