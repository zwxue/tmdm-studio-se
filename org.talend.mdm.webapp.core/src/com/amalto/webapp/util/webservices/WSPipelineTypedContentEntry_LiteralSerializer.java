...
public class WSPipelineTypedContentEntry_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns2_myWSExtractedContent_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSExtractedContent.class, ns2_WSExtractedContent_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSPipelineTypedContentEntry instance = new com.amalto.webapp.util.webservices.WSPipelineTypedContentEntry();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_wsExtractedContent_QNAME)) {
                ...
                instance.setWsExtractedContent((com.amalto.webapp.util.webservices.WSExtractedContent)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSPipelineTypedContentEntry instance = (com.amalto.webapp.util.webservices.WSPipelineTypedContentEntry)obj;
