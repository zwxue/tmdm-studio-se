...
public class WSDataModel_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    private static final QName ns1_xsdSchema_QNAME = new QName("", "xsdSchema");
    
    public WSDataModel_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSDataModel_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSDataModel instance = new com.amalto.webapp.util.webservices.WSDataModel();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_xsdSchema_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_xsdSchema_QNAME, reader, context);
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull");
                }
                instance.setXsdSchema((java.lang.String)member);
                reader.nextElementContent();
            } else {
                throw new DeserializationException("literal.unexpectedElementName", new Object[] { ns1_xsdSchema_QNAME, reader.getName() });
            }
        }
        else {
            throw new DeserializationException("literal.expectedElementName", reader.getName().toString());
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSDataModel instance = (com.amalto.webapp.util.webservices.WSDataModel)obj;
    ...
    public void doSerialize(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getXsdSchema() == null) {
            throw new SerializationException("literal.unexpectedNull");
        }
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getXsdSchema(), ns1_xsdSchema_QNAME, null, writer, context);
    }
}
