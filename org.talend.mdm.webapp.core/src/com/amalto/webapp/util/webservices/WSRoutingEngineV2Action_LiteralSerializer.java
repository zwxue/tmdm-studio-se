...
public class WSRoutingEngineV2Action_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2myns2_WSRoutingEngineV2ActionCode__WSRoutingEngineV2ActionCode_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSRoutingEngineV2ActionCode.class, ns2_WSRoutingEngineV2ActionCode_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSRoutingEngineV2Action instance = new com.amalto.webapp.util.webservices.WSRoutingEngineV2Action();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_wsAction_QNAME)) {
                ...
                instance.setWsAction((com.amalto.webapp.util.webservices.WSRoutingEngineV2ActionCode)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSRoutingEngineV2Action instance = (com.amalto.webapp.util.webservices.WSRoutingEngineV2Action)obj;
