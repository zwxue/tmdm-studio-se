...
public class WSPutUniverse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSUniverse_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSUniverse.class, ns2_WSUniverse_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSPutUniverse instance = new com.amalto.webapp.util.webservices.WSPutUniverse();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_wsUniverse_QNAME)) {
                ...
                instance.setWsUniverse((com.amalto.webapp.util.webservices.WSUniverse)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSPutUniverse instance = (com.amalto.webapp.util.webservices.WSPutUniverse)obj;
