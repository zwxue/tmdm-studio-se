...
public class WSTransformerVariablesMapping {
    ...
    protected com.amalto.webapp.util.webservices.WSTypedContent hardCoding;
    
    public WSTransformerVariablesMapping() {
    }
    
    public WSTransformerVariablesMapping(java.lang.String pipelineVariable, java.lang.String pluginVariable, com.amalto.webapp.util.webservices.WSTypedContent hardCoding) {
    ...
    public com.amalto.webapp.util.webservices.WSTypedContent getHardCoding() {
        return hardCoding;
    }
    
    public void setHardCoding(com.amalto.webapp.util.webservices.WSTypedContent hardCoding) {
        this.hardCoding = hardCoding;
    }
}
