...
public class WSPutVersioningSystemConfiguration_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSVersioningSystemConfiguration_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.workbench.webservices.WSVersioningSystemConfiguration.class, ns2_WSVersioningSystemConfiguration_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSPutVersioningSystemConfiguration instance = new com.amalto.workbench.webservices.WSPutVersioningSystemConfiguration();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_versioningSystemConfiguration_QNAME)) {
                ...
                instance.setVersioningSystemConfiguration((com.amalto.workbench.webservices.WSVersioningSystemConfiguration)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSPutVersioningSystemConfiguration instance = (com.amalto.workbench.webservices.WSPutVersioningSystemConfiguration)obj;
