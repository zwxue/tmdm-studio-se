...
public class WSRouterActionCode {
    ...
    public static final WSRouterActionCode START = new WSRouterActionCode(_START);
    public static final WSRouterActionCode STOP = new WSRouterActionCode(_STOP);
    public static final WSRouterActionCode SUSPEND = new WSRouterActionCode(_SUSPEND);
    public static final WSRouterActionCode RESUME = new WSRouterActionCode(_RESUME);
    public static final WSRouterActionCode STATUS = new WSRouterActionCode(_STATUS);
    
    protected WSRouterActionCode(java.lang.String value) {
        this.value = value;
    ...
    public static WSRouterActionCode fromValue(java.lang.String value)
    ...
    public static WSRouterActionCode fromString(String value)
        throws java.lang.IllegalStateException {
        WSRouterActionCode ret = (WSRouterActionCode)valueMap.get(value);
        if (ret != null) {
            return ret;
        }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof WSRouterActionCode)) {
            return false;
        }
        return ((WSRouterActionCode)obj).value.equals(value);
    }
