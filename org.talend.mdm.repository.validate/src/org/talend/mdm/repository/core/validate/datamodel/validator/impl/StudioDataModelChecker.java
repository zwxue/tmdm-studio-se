 ...
 * 
 */
public class StudioDataModelChecker extends DataModelChecker {
     ...
     * @param builder
     */
    public StudioDataModelChecker(IModelBuilder builder) {
        super(builder);
    }

    @Override
    public void initValidators() {
        addValidator(new StudioElementValidator());
    }
