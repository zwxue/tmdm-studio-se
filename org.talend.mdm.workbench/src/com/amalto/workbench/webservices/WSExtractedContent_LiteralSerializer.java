...
public class WSExtractedContent_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.workbench.webservices.WSExtractedContent instance = new com.amalto.workbench.webservices.WSExtractedContent();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_wsByteArray_QNAME)) {
                ...
                instance.setWsByteArray((com.amalto.workbench.webservices.WSByteArray)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSExtractedContent instance = (com.amalto.workbench.webservices.WSExtractedContent)obj;
