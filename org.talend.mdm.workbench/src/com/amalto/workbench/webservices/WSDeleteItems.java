...
public class WSDeleteItems {
     ...
     * 
     */
    public WSDeleteItems(final WSDataClusterPK wsDataClusterPK, final String conceptName, final WSWhereItem wsWhereItem, final int spellTreshold, final Boolean override) {
