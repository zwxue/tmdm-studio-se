...
public class WSVersioningUniverseVersions_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSVersioningUniverseVersionsTagStructure_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.workbench.webservices.WSVersioningUniverseVersionsTagStructure.class, ns2_WSVersioningUniverseVersions$2d$tagStructure_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSVersioningUniverseVersions instance = new com.amalto.workbench.webservices.WSVersioningUniverseVersions();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_tagStructure_QNAME))) {
            ...
            member = new com.amalto.workbench.webservices.WSVersioningUniverseVersionsTagStructure[values.size()];
            member = values.toArray((Object[]) member);
            instance.setTagStructure((com.amalto.workbench.webservices.WSVersioningUniverseVersionsTagStructure[])member);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSVersioningUniverseVersions instance = (com.amalto.workbench.webservices.WSVersioningUniverseVersions)obj;
