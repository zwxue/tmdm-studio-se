...
public class WSViewSearch {
     ...
     * 
     */
    public WSViewSearch(final WSDataClusterPK wsDataClusterPK, final WSViewPK wsViewPK, final WSWhereItem whereItem, final int spellTreshold, final int skip, final int maxItems, final String orderBy, final String direction) {
