...
public class WSSynchronizationItem {
     ...
     * 
     */
    public WSSynchronizationItem(final WSItemPK wsItemPK, final String localRevisionID, final String lastRunPlan, final WSSynchronizationItemStatus status, final String resolvedProjection, final List<WSSynchronizationItem.RemoteInstances> remoteInstances) {
    ...
    public static class RemoteInstances {
         ...
         * 
         */
        public RemoteInstances(final String remoteSystemName, final String remoteRevisionID, final String xml, final XMLGregorianCalendar lastLocalSynchronizationTime) {
