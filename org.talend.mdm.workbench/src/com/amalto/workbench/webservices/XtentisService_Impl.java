...
public class XtentisService_Impl extends com.sun.xml.rpc.client.BasicService implements XtentisService {
    ...
    private static final Class xtentisPort_PortClass = com.amalto.workbench.webservices.XtentisPort.class;
    
    public XtentisService_Impl() {
        super(serviceName, new QName[] {
                        ns1_XtentisPort_QNAME
                    },
            new com.amalto.workbench.webservices.XtentisService_SerializerRegistry().getRegistry());
    ...
    public com.amalto.workbench.webservices.XtentisPort getXtentisPort() {
        ...
        com.amalto.workbench.webservices.XtentisPort_Stub stub = new com.amalto.workbench.webservices.XtentisPort_Stub(handlerChain);
        try {
