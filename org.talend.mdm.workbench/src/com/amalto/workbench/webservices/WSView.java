 ...
 *         &lt;element name="isTransformerActive" type="{urn-com-amalto-xtentis-webservice}WSBoolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class WSView {
     ...
     * 
     */
    public WSView(final String name, final String description, final List<String> viewableBusinessElements, final List<WSWhereCondition> whereConditions, final List<String> searchableBusinessElements, final String transformerPK, final WSBoolean isTransformerActive) {
        this.name = name;
