...
public class WSView_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns2_myWSBoolean_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.workbench.webservices.WSBoolean.class, ns2_WSBoolean_TYPE_QNAME);
    }
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_isTransformerActive_QNAME)) {
                ...
                instance.setIsTransformerActive((com.amalto.workbench.webservices.WSBoolean)member);
                reader.nextElementContent();
            }
        }
