...
public class WSStoredProcedure_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    private static final QName ns1_refreshCache_QNAME = new QName("", "refreshCache");
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_refreshCache_QNAME)) {
                member = ns3_myns3__boolean__java_lang_Boolean_Boolean_Serializer.deserialize(ns1_refreshCache_QNAME, reader, context);
                instance.setRefreshCache((java.lang.Boolean)member);
                reader.nextElementContent();
            }
        }
    ...
    public void doSerialize(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        ns3_myns3__boolean__java_lang_Boolean_Boolean_Serializer.serialize(instance.getRefreshCache(), ns1_refreshCache_QNAME, null, writer, context);
    }
}
