...
public class XtentisPort_Stub
    ...
    private static final int existsTransformerV2_OPCODE = 0;
    private static final int getUniverse_OPCODE = 1;
    private static final int count_OPCODE = 2;
    private static final int getBackgroundJob_OPCODE = 3;
    ...
    private static final int deleteSynchronizationPlan_OPCODE = 17;
    private static final int getMenu_OPCODE = 18;
    private static final int getTransformerPKs_OPCODE = 19;
    private static final int recoverDroppedItem_OPCODE = 20;
    private static final int getSynchronizationItemPKs_OPCODE = 21;
    ...
    private static final int getStoredProcedurePKs_OPCODE = 53;
    ...
    private static final int getRoutingRulePKs_OPCODE = 75;
    private static final int serviceAction_OPCODE = 76;
    private static final int existsRoutingOrderV2_OPCODE = 77;
    private static final int findBackgroundJobPKs_OPCODE = 78;
    ...
    private static final int findAllDroppedItemsPKs_OPCODE = 87;
    private static final int getRolePKs_OPCODE = 88;
    private static final int processBytesUsingTransformerAsBackgroundJob_OPCODE = 89;
    ...
    private static final int putItemWithCustomReport_OPCODE = 101;
    private static final int synchronizationPutObjectXML_OPCODE = 102;
    private static final int putSynchronizationPlan_OPCODE = 103;
    private static final int deleteTransformer_OPCODE = 104;
    private static final int getChildrenItems_OPCODE = 105;
    private static final int getVersioningSystemConfiguration_OPCODE = 106;
    private static final int processBytesUsingTransformer_OPCODE = 107;
    ...
    private static final int existsSynchronizationPlan_OPCODE = 115;
    private static final int putRoutingRule_OPCODE = 116;
    private static final int workflowAssignTask_OPCODE = 117;
    private static final int existsUniverse_OPCODE = 118;
    ...
    private static final int putItemWithReportArray_OPCODE = 128;
    private static final int extractUsingTransformer_OPCODE = 129;
    private static final int putServiceConfiguration_OPCODE = 130;
    private static final int synchronizationPlanAction_OPCODE = 131;
    private static final int deleteStoredProcedure_OPCODE = 132;
    private static final int getTransformerV2_OPCODE = 133;
    private static final int getMDMCategory_OPCODE = 134;
    private static final int synchronizationGetUnsynchronizedObjectsIDs_OPCODE = 135;
    private static final int processFileUsingTransformerAsBackgroundJob_OPCODE = 136;
    private static final int getUniverseByRevision_OPCODE = 137;
    private static final int getComponentVersion_OPCODE = 138;
    private static final int synchronizationPutItemXML_OPCODE = 139;
    private static final int quickSearch_OPCODE = 140;
    private static final int workflowUnassignTask_OPCODE = 141;
