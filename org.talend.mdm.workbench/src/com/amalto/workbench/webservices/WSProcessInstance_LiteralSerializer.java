...
public class WSProcessInstance_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    private static final QName ns1_name_QNAME = new QName("", "name");
    private static final QName ns3_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
    private CombinedSerializer ns3_myns3_string__java_lang_String_String_Serializer;
    private static final QName ns1_state_QNAME = new QName("", "state");
    
    public WSProcessInstance_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSProcessInstance_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.workbench.webservices.WSProcessInstance instance = new com.amalto.workbench.webservices.WSProcessInstance();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        while (reader.getState() == XMLReader.START) {
            ...
            else if (elementName.equals(ns1_state_QNAME)) {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSProcessInstance instance = (com.amalto.workbench.webservices.WSProcessInstance)obj;
