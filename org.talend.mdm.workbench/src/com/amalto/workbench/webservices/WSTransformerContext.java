...
public class WSTransformerContext {
     ...
     * 
     */
    public WSTransformerContext(final WSTransformerV2PK wsTransformerPK, final WSTransformerContext.Pipeline pipeline, final WSTransformerContext.ProjectedItemPKs projectedItemPKs) {
    ...
    public static class Pipeline {
         ...
         * 
         */
        public Pipeline(final List<WSTransformerContext.Pipeline.PipelineItem> pipelineItem) {
        ...
        public static class PipelineItem {
             ...
             * 
             */
            public PipelineItem(final String variable, final WSTypedContent wsTypedContent) {
    ...
    public static class ProjectedItemPKs {
         ...
         * 
         */
        public ProjectedItemPKs(final List<WSItemPK> wsItemPOJOPK) {
