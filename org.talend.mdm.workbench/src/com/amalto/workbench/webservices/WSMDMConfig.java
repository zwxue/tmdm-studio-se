...
public class WSMDMConfig {
     ...
     * 
     */
    public WSMDMConfig(final String serverName, final String serverPort, final String userName, final String password, final String xdbDriver, final String xdbID, final String xdbUrl, final String isupurl) {
