...
public class WSBusinessSimpleTemplate {
     ...
     * 
     */
    public WSBusinessSimpleTemplate() {
        super();
    }
     ...
     * 
     */
    public WSBusinessSimpleTemplate(final String name, final String xsdBaseType, final String pattern) {
        this.name = name;
        this.xsdBaseType = xsdBaseType;
