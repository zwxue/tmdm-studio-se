 ...
 *         &lt;element name="datacluster" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="pivot" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
public class WSPartialPutItem {
     ...
     * 
     */
    public WSPartialPutItem(final String xml, final String datacluster, final String pivot, final String datamodel, final String keyXPath, final Integer startingPosition, final Boolean overwrite, final boolean report) {
        this.xml = xml;
