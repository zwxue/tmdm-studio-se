...
public class WSPutItemByOperatorType_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    private static final QName ns1_operatortype_QNAME = new QName("", "operatortype");
    private static final QName ns2_WSOperatorType_TYPE_QNAME = new QName("urn-com-amalto-xtentis-webservice", "WSOperatorType");
    private CombinedSerializer ns2myns2_WSOperatorType__WSOperatorType_LiteralSerializer;
    
    public WSPutItemByOperatorType_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSPutItemByOperatorType_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns2myns2_WSOperatorType__WSOperatorType_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.workbench.webservices.WSOperatorType.class, ns2_WSOperatorType_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSPutItemByOperatorType instance = new com.amalto.workbench.webservices.WSPutItemByOperatorType();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_operatortype_QNAME)) {
                member = ns2myns2_WSOperatorType__WSOperatorType_LiteralSerializer.deserialize(ns1_operatortype_QNAME, reader, context);
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull");
                }
                instance.setOperatortype((com.amalto.workbench.webservices.WSOperatorType)member);
                reader.nextElementContent();
            } else {
                throw new DeserializationException("literal.unexpectedElementName", new Object[] { ns1_operatortype_QNAME, reader.getName() });
            }
        }
        else {
            throw new DeserializationException("literal.expectedElementName", reader.getName().toString());
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSPutItemByOperatorType instance = (com.amalto.workbench.webservices.WSPutItemByOperatorType)obj;
    ...
    public void doSerialize(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getOperatortype() == null) {
            throw new SerializationException("literal.unexpectedNull");
        }
        ns2myns2_WSOperatorType__WSOperatorType_LiteralSerializer.serialize(instance.getOperatortype(), ns1_operatortype_QNAME, null, writer, context);
    }
}
