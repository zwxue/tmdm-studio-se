...
public class WSSynchronizationPlanStatus {
     ...
     * 
     */
    public WSSynchronizationPlanStatus(final WSSynchronizationPlanStatusCode wsStatusCode, final String statusMessage, final XMLGregorianCalendar lastRunStarted, final XMLGregorianCalendar lastRunStopped) {
