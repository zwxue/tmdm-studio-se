...
public class WSRoutingOrderV2Array_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2_myWSRoutingOrderV2_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.workbench.webservices.WSRoutingOrderV2.class, ns2_WSRoutingOrderV2_TYPE_QNAME);
    }
    
    public Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSRoutingOrderV2Array instance = new com.amalto.workbench.webservices.WSRoutingOrderV2Array();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_wsRoutingOrder_QNAME))) {
            ...
            member = new com.amalto.workbench.webservices.WSRoutingOrderV2[values.size()];
            member = values.toArray((Object[]) member);
            instance.setWsRoutingOrder((com.amalto.workbench.webservices.WSRoutingOrderV2[])member);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.workbench.webservices.WSRoutingOrderV2Array instance = (com.amalto.workbench.webservices.WSRoutingOrderV2Array)obj;
