...
public class WSProcessBytesUsingTransformerAsBackgroundJob {
     ...
     * 
     */
    public WSProcessBytesUsingTransformerAsBackgroundJob(final WSByteArray wsBytes, final String contentType, final WSTransformerPK wsTransformerPK, final WSOutputDecisionTable wsOutputDecisionTable) {
