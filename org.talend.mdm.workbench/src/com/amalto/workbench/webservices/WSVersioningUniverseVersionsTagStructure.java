...
public class WSVersioningUniverseVersionsTagStructure {
    ...
    protected com.amalto.workbench.webservices.WSStringArray clusters;
    
    public WSVersioningUniverseVersionsTagStructure() {
    }
    
    public WSVersioningUniverseVersionsTagStructure(java.lang.String tagName, java.lang.String lastDate, java.lang.String lastAuthor, java.lang.String lastComment, com.amalto.workbench.webservices.WSStringArray clusters) {
    ...
    public com.amalto.workbench.webservices.WSStringArray getClusters() {
        return clusters;
    }
    
    public void setClusters(com.amalto.workbench.webservices.WSStringArray clusters) {
        this.clusters = clusters;
    }
}
