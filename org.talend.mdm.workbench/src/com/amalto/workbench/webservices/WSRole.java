...
public class WSRole {
     ...
     * 
     */
    public WSRole(final String name, final String description, final List<WSRole.Specification> specification) {
        this.name = name;
    ...
    public static class Specification {
         ...
         * 
         */
        public Specification(final String objectType, final boolean admin, final List<WSRole.Specification.Instance> instance) {
        ...
        public static class Instance {
             ...
             * 
             */
            public Instance(final String instanceName, final boolean writable, final List<String> parameter) {
