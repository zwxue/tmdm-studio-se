...
public class WSGetItemsByCustomFKFilters {
     ...
     * 
     */
    public WSGetItemsByCustomFKFilters(final WSDataClusterPK wsDataClusterPK, final String conceptName, final WSStringArray viewablePaths, final String injectedXpath, final int skip, final int maxItems, final String orderBy, final String direction, final Boolean returnCount, final WSWhereItem whereItem) {
