...
public class WSVersioningUniverseVersions {
     ...
     * 
     */
    public WSVersioningUniverseVersions(final List<WSVersioningUniverseVersions.TagStructure> tagStructure) {
    ...
    public static class TagStructure {
         ...
         * 
         */
        public TagStructure(final String tagName, final String lastDate, final String lastAuthor, final String lastComment, final WSStringArray clusters) {
