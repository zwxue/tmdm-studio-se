...
public class WSSynchronizationGetUnsynchronizedObjectsIDs {
     ...
     * 
     */
    public WSSynchronizationGetUnsynchronizedObjectsIDs(final String revisionID, final String objectName, final String instancePattern, final String synchronizationPlanName) {
