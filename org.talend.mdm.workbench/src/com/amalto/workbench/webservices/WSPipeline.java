...
public class WSPipeline {
     ...
     * 
     */
    public WSPipeline(final List<WSPipeline.TypedContentEntry> typedContentEntry) {
    ...
    public static class TypedContentEntry {
         ...
         * 
         */
        public TypedContentEntry(final String output, final WSExtractedContent wsExtractedContent) {
            this.output = output;
