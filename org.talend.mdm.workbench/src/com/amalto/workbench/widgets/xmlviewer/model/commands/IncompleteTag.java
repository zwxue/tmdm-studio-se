...
/**
 */
public class IncompleteTag implements RelateElementsCommand {

	public void excecute(XMLNode rootNode, NoDefTagDefinitionProvider tagDefinitinonProvider) {
		ElementsToRelate.node.setParent(ElementsToRelate.currentNode);
	}
