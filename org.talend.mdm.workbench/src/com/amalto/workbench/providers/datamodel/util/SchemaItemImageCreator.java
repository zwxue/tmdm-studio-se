...
public class SchemaItemImageCreator {
	...
	protected Image getImageForXSDAttributeUse(XSDAttributeUse element){
		...
		if ("xmlns".equals(element.getAttributeDeclaration().getTargetNamespace()))
		...
		try {
			...
			if ("appinfo".equals(element.getLocalName())) {
				...
				if (source != null) {
					...
					if (source.equals("X_Retrieve_FKinfos"))
						return ImageCache.getCreatedImage( EImage.KEYINFO.getPath());
					...
					if(source.startsWith("X_Display_Format_"))
