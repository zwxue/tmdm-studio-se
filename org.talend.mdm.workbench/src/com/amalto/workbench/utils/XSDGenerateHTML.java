...
public class XSDGenerateHTML implements IPlatformRunnable {
    ...
    public void loadAndPrint(String xsdFile) throws Exception {
        ...
        for (Iterator i = all.iterator(); i.hasNext();) {
            ...
            String key = (parentElementDeclaration == null ? "" : parentElementDeclaration.getName() + "::")
            ...
            System.out
                    .print("<div class='reprHeader'><span class='reprdef'>XML&nbsp;Representation&nbsp;Summary:&nbsp;</span><code>");
                ...
                for (Iterator attributeUses = xsdComplexTypeDefinition.getAttributeUses().iterator(); attributeUses.hasNext();) {
                    ...
                    if (!"ignored".equals(elementDeclarationMarkup)) {
                        ...
                        if (attributeDeclarationMarkup == null) {
                            attributeDeclarationMarkup = getAttributeDeclarationMarkup(elementDeclarationName + "."
                        ...
                        if (attributeDeclarationDocumentation == null) {
                            attributeDeclarationDocumentation = getAttributeDeclarationDocumentation(elementDeclarationName + "."
                                    + attributeDeclarationName);
                        }
                    }
        ...
        for (Iterator i = allTypeDefinitions.iterator(); i.hasNext();) {
            ...
            if (xsdTypeDefinition instanceof XSDSimpleTypeDefinition && xsdTypeDefinition.getElement() != null
                ...
                effectiveFacetValues.append(xsdSimpleTypeDefinition.isSetVariety() ? "<b>" + xsdSimpleTypeDefinition.getVariety()
                        + "</b>" : "<em>absent</em>");
                ...
                effectiveFacetValues
                        .append("anyUnionType".equals(xsdSimpleTypeDefinition.getName()) ? "*"
                                : XSDCardinality.COUNTABLY_INFINITE_LITERAL == xsdSimpleTypeDefinition.getCardinalityFacet()
                                        .getValue() ? "countably infinite" : xsdSimpleTypeDefinition.getCardinalityFacet()
                                        .getValue().getName());
                effectiveFacetValues.append("<br>\n");
