...
public class ResourcesUtil {
	...
	public static void main(String[] args) {
		...
		try {
			postResourcesFromFile("demo2", "d:/bud.xsd",
					"http://localhost:8080" + cmURI);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	public static byte[] getResourceFile(String uri) {
	     ...
	     try
	     {
	    	 ...
	    	 httpClient.getState().setCredentials(null,null, new org.apache.commons.httpclient.UsernamePasswordCredentials("admin","talend"));
	...
	private static String getXMLString(String uri) {
		...
		httpclient.getCredentialsProvider().setCredentials(
				new AuthScope(getEndpointHost(uri), Integer
						.valueOf(getEndpointPort(uri))),
	...
	public static HashMap<String, String> getResourcesMapFromURI(String uri) {
		...
		for (Iterator iterator = document.getRootElement().elementIterator(
			...
			if (nameElement != null && uriElement != null) {
				contentMap.put(nameElement.getStringValue(), uriElement
						.getStringValue());
			} else {
				contentMap.put(element.getStringValue(), uri + "/"
	...
	public static List<String> getResourcesNameListFromURI(String uri)
			throws Exception {
	...
	public static void postResourcesFromFile(String typeName, String pathName,
	...
	/*
	 * public static void postPicFromFile(String typeName,String pathName,String
	 * uriPre) throws Exception { String content=readFileAsString(pathName);
	 * String uri=uriPre+"imageserver/secure/ImageUploadServlet"; // String
	...
	public static void postResourcesFromContentString(String content,
			String uri, String typeName) throws Exception {
	...
	private static void postContent(String uri, HttpPost httppost)
