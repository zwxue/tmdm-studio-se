...
package org.talend.mdm.webapp.gxt.framework.server.util;
 ...
 * This listener merely documents the occurrence of such events in the application log associated with our servlet
 * context.
 * 
...
public final class SessionListener implements ServletContextListener, HttpSessionAttributeListener, HttpSessionListener {
    ...
    private void log(String message) {
        ...
        if (context != null)
            ...
            log.debug("SessionListener: " + message);
    ...
    private void log(String message, Throwable throwable) {
        ...
        if (context != null)
            ...
            if (log.isDebugEnabled())
                log.debug("SessionListener: " + message, throwable);
        }
