...
public class WSGetItemsPivotIndex_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSGetItemsPivotIndex instance = new com.amalto.webapp.util.webservices.WSGetItemsPivotIndex();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_pivotWithKeys_QNAME)) {
                ...
                instance.setPivotWithKeys((com.amalto.webapp.util.webservices.WSLinkedHashMap)member);
                reader.nextElementContent();
            } else {
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_indexPaths_QNAME)) {
                ...
                instance.setIndexPaths((com.amalto.webapp.util.webservices.WSStringArray)member);
                reader.nextElementContent();
            } else {
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_pivotDirections_QNAME)) {
                ...
                instance.setPivotDirections((com.amalto.webapp.util.webservices.WSStringArray)member);
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_indexDirections_QNAME)) {
                ...
                instance.setIndexDirections((com.amalto.webapp.util.webservices.WSStringArray)member);
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSGetItemsPivotIndex instance = (com.amalto.webapp.util.webservices.WSGetItemsPivotIndex)obj;
