...
public class WSGetTransformerPKs_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    private static final QName ns1_regex_QNAME = new QName("", "regex");
    private static final QName ns3_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
    private CombinedSerializer ns3_myns3_string__java_lang_String_String_Serializer;
    
    public WSGetTransformerPKs_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public WSGetTransformerPKs_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSGetTransformerPKs instance = new com.amalto.webapp.util.webservices.WSGetTransformerPKs();
        Object member=null;
        QName elementName;
        List values;
        Object value;
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSGetTransformerPKs instance = (com.amalto.webapp.util.webservices.WSGetTransformerPKs)obj;
