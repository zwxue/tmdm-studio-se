...
public class WSSynchronizationPlanStatus {
    protected com.amalto.webapp.util.webservices.WSSynchronizationPlanStatusCode wsStatusCode;
    ...
    public WSSynchronizationPlanStatus(com.amalto.webapp.util.webservices.WSSynchronizationPlanStatusCode wsStatusCode, java.lang.String statusMessage, java.util.Calendar lastRunStarted, java.util.Calendar lastRunStopped) {
    ...
    public com.amalto.webapp.util.webservices.WSSynchronizationPlanStatusCode getWsStatusCode() {
        return wsStatusCode;
    }
    
    public void setWsStatusCode(com.amalto.webapp.util.webservices.WSSynchronizationPlanStatusCode wsStatusCode) {
        this.wsStatusCode = wsStatusCode;
    }
