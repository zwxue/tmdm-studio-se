...
public class WSVersioningObjectsHistoryObjects {
    ...
    public WSVersioningObjectsHistoryObjects(java.lang.String type, java.lang.String name, com.amalto.webapp.util.webservices.WSVersioningHistoryEntry[] wsHistoryEntries) {
        this.type = type;
        this.name = name;
