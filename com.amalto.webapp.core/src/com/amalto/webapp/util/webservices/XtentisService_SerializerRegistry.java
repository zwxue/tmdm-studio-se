...
public class XtentisService_SerializerRegistry implements SerializerConstants {
    ...
    public TypeMappingRegistry getRegistry() {
        ...
        }
        {
            ...
            CombinedSerializer serializer = new com.amalto.webapp.util.webservices.WSUpdateReportItemPOJO_LiteralSerializer(type, "", DONT_ENCODE_TYPE);
            registerSerializer(mapping2,com.amalto.webapp.util.webservices.WSUpdateReportItemPOJO.class, type, serializer);
        }
        {
        ...
        }
        {
            ...
            CombinedSerializer serializer = new com.amalto.webapp.util.webservices.WSUpdateReportItemArray_LiteralSerializer(type, "", DONT_ENCODE_TYPE);
            registerSerializer(mapping2,com.amalto.webapp.util.webservices.WSUpdateReportItemArray.class, type, serializer);
        }
        {
