...
public class WSVersioningObjectsHistoryObjects_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSVersioningObjectsHistoryObjects instance = new com.amalto.webapp.util.webservices.WSVersioningObjectsHistoryObjects();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_wsHistoryEntries_QNAME))) {
            ...
            instance.setWsHistoryEntries(new com.amalto.webapp.util.webservices.WSVersioningHistoryEntry[0]);
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSVersioningObjectsHistoryObjects instance = (com.amalto.webapp.util.webservices.WSVersioningObjectsHistoryObjects)obj;
