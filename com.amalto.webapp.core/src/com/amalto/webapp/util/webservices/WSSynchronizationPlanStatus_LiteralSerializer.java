...
public class WSSynchronizationPlanStatus_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns2myns2_WSSynchronizationPlanStatusCode__WSSynchronizationPlanStatusCode_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.amalto.webapp.util.webservices.WSSynchronizationPlanStatusCode.class, ns2_WSSynchronizationPlanStatusCode_TYPE_QNAME);
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        com.amalto.webapp.util.webservices.WSSynchronizationPlanStatus instance = new com.amalto.webapp.util.webservices.WSSynchronizationPlanStatus();
        Object member=null;
        QName elementName;
        List values;
        Object value;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_wsStatusCode_QNAME)) {
                ...
                instance.setWsStatusCode((com.amalto.webapp.util.webservices.WSSynchronizationPlanStatusCode)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.amalto.webapp.util.webservices.WSSynchronizationPlanStatus instance = (com.amalto.webapp.util.webservices.WSSynchronizationPlanStatus)obj;
