...
AS WAR
a-Unzip the war downloaded from eXist web site as jboss/server/default/deploy/eXist-1.2.4.war
b-add the file asWAR/jboss-web.xml to jboss/server/default/deploy/eXist-1.2.4.war/WEB-INF/
c-replace the file in jboss/server/default/deploy/eXist-1.2.4.war/WEB-INF/conf.xml with the one in asWAR/conf.xml
