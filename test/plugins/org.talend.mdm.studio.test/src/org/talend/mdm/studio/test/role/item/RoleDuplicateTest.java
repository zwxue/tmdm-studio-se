...
public class RoleDuplicateTest extends TalendSWTBotForMDM {
    ...
    public void roleDuplicateTest() {
        ...
        duplicateMenu.click();
        SWTBotShell shell = bot.shell("Pasting instance Manager_MWest");
        shell.activate();
        bot.text("CopyOfManager_MWest").setText("DuplicateRole");
        sleep();
        bot.button("OK").click();
