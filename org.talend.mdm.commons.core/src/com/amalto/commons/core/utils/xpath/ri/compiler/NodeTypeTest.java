...
public class NodeTypeTest extends NodeTest {
    ...
    @Override
    public NodeTest clone(boolean deep) {
        return new NodeTypeTest(this.nodeType);
    }
    ...
    public boolean equals(Object obj) {
        if (! (obj instanceof NodeTypeTest)) return false;
        NodeTypeTest ntt = (NodeTypeTest)obj;
        if (this.nodeType != ntt.nodeType) return false;
    	return true;
    }
}
