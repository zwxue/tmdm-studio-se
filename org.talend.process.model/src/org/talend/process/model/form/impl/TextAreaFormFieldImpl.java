 ...
 * <ul>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#isDuplicate <em>Duplicate</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#isLimitNumberOfDuplication <em>Limit Number Of Duplication</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#getMaxNumberOfDuplication <em>Max Number Of Duplication</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#isLimitMinNumberOfDuplication <em>Limit Min Number Of Duplication</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#getMinNumberOfDuplication <em>Min Number Of Duplication</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#getDisplayLabelForAdd <em>Display Label For Add</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#getTooltipForAdd <em>Tooltip For Add</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#getDisplayLabelForRemove <em>Display Label For Remove</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#getTooltipForRemove <em>Tooltip For Remove</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.TextAreaFormFieldImpl#getMaxHeigth <em>Max Heigth</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextAreaFormFieldImpl extends SingleValuatedFormFieldImpl implements TextAreaFormField {
    ...
    public void setDuplicate(boolean newDuplicate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__DUPLICATE, oldDuplicate, duplicate));
    }
    ...
    public void setLimitNumberOfDuplication(boolean newLimitNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__LIMIT_NUMBER_OF_DUPLICATION, oldLimitNumberOfDuplication, limitNumberOfDuplication));
    }
    ...
    public void setMaxNumberOfDuplication(String newMaxNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__MAX_NUMBER_OF_DUPLICATION, oldMaxNumberOfDuplication, maxNumberOfDuplication));
    }
    ...
    public void setLimitMinNumberOfDuplication(boolean newLimitMinNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__LIMIT_MIN_NUMBER_OF_DUPLICATION, oldLimitMinNumberOfDuplication, limitMinNumberOfDuplication));
    }
    ...
    public void setMinNumberOfDuplication(String newMinNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__MIN_NUMBER_OF_DUPLICATION, oldMinNumberOfDuplication, minNumberOfDuplication));
    }
    ...
    public void setDisplayLabelForAdd(String newDisplayLabelForAdd) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__DISPLAY_LABEL_FOR_ADD, oldDisplayLabelForAdd, displayLabelForAdd));
    }
    ...
    public void setTooltipForAdd(String newTooltipForAdd) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__TOOLTIP_FOR_ADD, oldTooltipForAdd, tooltipForAdd));
    }
    ...
    public void setDisplayLabelForRemove(String newDisplayLabelForRemove) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__DISPLAY_LABEL_FOR_REMOVE, oldDisplayLabelForRemove, displayLabelForRemove));
    }
    ...
    public void setTooltipForRemove(String newTooltipForRemove) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXT_AREA_FORM_FIELD__TOOLTIP_FOR_REMOVE, oldTooltipForRemove, tooltipForRemove));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case FormPackage.TEXT_AREA_FORM_FIELD__DUPLICATE:
                return isDuplicate();
            case FormPackage.TEXT_AREA_FORM_FIELD__LIMIT_NUMBER_OF_DUPLICATION:
                return isLimitNumberOfDuplication();
            case FormPackage.TEXT_AREA_FORM_FIELD__MAX_NUMBER_OF_DUPLICATION:
                return getMaxNumberOfDuplication();
            case FormPackage.TEXT_AREA_FORM_FIELD__LIMIT_MIN_NUMBER_OF_DUPLICATION:
                return isLimitMinNumberOfDuplication();
            case FormPackage.TEXT_AREA_FORM_FIELD__MIN_NUMBER_OF_DUPLICATION:
                return getMinNumberOfDuplication();
            case FormPackage.TEXT_AREA_FORM_FIELD__DISPLAY_LABEL_FOR_ADD:
                return getDisplayLabelForAdd();
            case FormPackage.TEXT_AREA_FORM_FIELD__TOOLTIP_FOR_ADD:
                return getTooltipForAdd();
            case FormPackage.TEXT_AREA_FORM_FIELD__DISPLAY_LABEL_FOR_REMOVE:
                return getDisplayLabelForRemove();
            case FormPackage.TEXT_AREA_FORM_FIELD__TOOLTIP_FOR_REMOVE:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Duplicable.class) {
            switch (derivedFeatureID) {
                case FormPackage.TEXT_AREA_FORM_FIELD__DUPLICATE: return FormPackage.DUPLICABLE__DUPLICATE;
                case FormPackage.TEXT_AREA_FORM_FIELD__LIMIT_NUMBER_OF_DUPLICATION: return FormPackage.DUPLICABLE__LIMIT_NUMBER_OF_DUPLICATION;
                case FormPackage.TEXT_AREA_FORM_FIELD__MAX_NUMBER_OF_DUPLICATION: return FormPackage.DUPLICABLE__MAX_NUMBER_OF_DUPLICATION;
                case FormPackage.TEXT_AREA_FORM_FIELD__LIMIT_MIN_NUMBER_OF_DUPLICATION: return FormPackage.DUPLICABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.TEXT_AREA_FORM_FIELD__MIN_NUMBER_OF_DUPLICATION: return FormPackage.DUPLICABLE__MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.TEXT_AREA_FORM_FIELD__DISPLAY_LABEL_FOR_ADD: return FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_ADD;
                case FormPackage.TEXT_AREA_FORM_FIELD__TOOLTIP_FOR_ADD: return FormPackage.DUPLICABLE__TOOLTIP_FOR_ADD;
                case FormPackage.TEXT_AREA_FORM_FIELD__DISPLAY_LABEL_FOR_REMOVE: return FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_REMOVE;
                case FormPackage.TEXT_AREA_FORM_FIELD__TOOLTIP_FOR_REMOVE: return FormPackage.DUPLICABLE__TOOLTIP_FOR_REMOVE;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Duplicable.class) {
            switch (baseFeatureID) {
                case FormPackage.DUPLICABLE__DUPLICATE: return FormPackage.TEXT_AREA_FORM_FIELD__DUPLICATE;
                case FormPackage.DUPLICABLE__LIMIT_NUMBER_OF_DUPLICATION: return FormPackage.TEXT_AREA_FORM_FIELD__LIMIT_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MAX_NUMBER_OF_DUPLICATION: return FormPackage.TEXT_AREA_FORM_FIELD__MAX_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION: return FormPackage.TEXT_AREA_FORM_FIELD__LIMIT_MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MIN_NUMBER_OF_DUPLICATION: return FormPackage.TEXT_AREA_FORM_FIELD__MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_ADD: return FormPackage.TEXT_AREA_FORM_FIELD__DISPLAY_LABEL_FOR_ADD;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_ADD: return FormPackage.TEXT_AREA_FORM_FIELD__TOOLTIP_FOR_ADD;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_REMOVE: return FormPackage.TEXT_AREA_FORM_FIELD__DISPLAY_LABEL_FOR_REMOVE;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_REMOVE: return FormPackage.TEXT_AREA_FORM_FIELD__TOOLTIP_FOR_REMOVE;
                default: return -1;
            }
        }
