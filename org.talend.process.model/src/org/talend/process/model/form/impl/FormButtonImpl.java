 ...
 * <ul>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getScript <em>Script</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getTooltip <em>Tooltip</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getWidgetLayoutInfo <em>Widget Layout Info</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getDisplayLabel <em>Display Label</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getShowDisplayLabel <em>Show Display Label</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#isAllowHTMLForDisplayLabel <em>Allow HTML For Display Label</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getHtmlAttributes <em>Html Attributes</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getRealHtmlAttributes <em>Real Html Attributes</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getDependOn <em>Depend On</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#isDisplayDependentWidgetOnlyOnEventTriggered <em>Display Dependent Widget Only On Event Triggered</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getScriptAfterEvent <em>Script After Event</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getParentOf <em>Parent Of</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#isMandatory <em>Mandatory</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getLabelPosition <em>Label Position</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getInputConnectors <em>Input Connectors</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getOutputConnectors <em>Output Connectors</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getAfterEventConnectors <em>After Event Connectors</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.FormButtonImpl#getLabelBehavior <em>Label Behavior</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FormButtonImpl extends EObjectImpl implements FormButton {
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM_BUTTON__LABEL, oldLabel, label));
    }
    ...
    public NotificationChain basicSetScript(GroovyScript newScript, NotificationChain msgs) {
        ...
        script = newScript;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.FORM_BUTTON__SCRIPT, oldScript, newScript);
    ...
    public void setScript(GroovyScript newScript) {
        if (newScript != script) {
            ...
            if (script != null)
                msgs = ((InternalEObject)script).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.FORM_BUTTON__SCRIPT, null, msgs);
            if (newScript != null)
                msgs = ((InternalEObject)newScript).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormPackage.FORM_BUTTON__SCRIPT, null, msgs);
            msgs = basicSetScript(newScript, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM_BUTTON__SCRIPT, newScript, newScript));
    }
    ...
    public void setTooltip(String newTooltip) {
        ...
        tooltip = newTooltip;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM_BUTTON__TOOLTIP, oldTooltip, tooltip));
    }
    ...
    public void setDisplayLabel(String newDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM_BUTTON__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
    }
    ...
    public NotificationChain basicSetScriptAfterEvent(GroovyScript newScriptAfterEvent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.FORM_BUTTON__SCRIPT_AFTER_EVENT, oldScriptAfterEvent, newScriptAfterEvent);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setScriptAfterEvent(GroovyScript newScriptAfterEvent) {
        if (newScriptAfterEvent != scriptAfterEvent) {
            ...
            if (scriptAfterEvent != null)
                msgs = ((InternalEObject)scriptAfterEvent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.FORM_BUTTON__SCRIPT_AFTER_EVENT, null, msgs);
            if (newScriptAfterEvent != null)
                msgs = ((InternalEObject)newScriptAfterEvent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormPackage.FORM_BUTTON__SCRIPT_AFTER_EVENT, null, msgs);
            msgs = basicSetScriptAfterEvent(newScriptAfterEvent, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM_BUTTON__SCRIPT_AFTER_EVENT, newScriptAfterEvent, newScriptAfterEvent));
    }
    ...
    public EList<Connector> getInputConnectors() {
        if (inputConnectors == null) {
            inputConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, FormPackage.FORM_BUTTON__INPUT_CONNECTORS);
        }
    ...
    public EList<Connector> getOutputConnectors() {
        if (outputConnectors == null) {
            outputConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, FormPackage.FORM_BUTTON__OUTPUT_CONNECTORS);
        }
    ...
    public EList<Connector> getAfterEventConnectors() {
        if (afterEventConnectors == null) {
            afterEventConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, FormPackage.FORM_BUTTON__AFTER_EVENT_CONNECTORS);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case FormPackage.FORM_BUTTON__SCRIPT:
            ...
            case FormPackage.FORM_BUTTON__SCRIPT_AFTER_EVENT:
            ...
            case FormPackage.FORM_BUTTON__INPUT_CONNECTORS:
                return ((InternalEList<?>)getInputConnectors()).basicRemove(otherEnd, msgs);
            case FormPackage.FORM_BUTTON__OUTPUT_CONNECTORS:
                return ((InternalEList<?>)getOutputConnectors()).basicRemove(otherEnd, msgs);
            case FormPackage.FORM_BUTTON__AFTER_EVENT_CONNECTORS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case FormPackage.FORM_BUTTON__NAME:
                return getName();
            case FormPackage.FORM_BUTTON__LABEL:
                return getLabel();
            case FormPackage.FORM_BUTTON__TEXT_ANNOTATION_ATTACHMENT:
