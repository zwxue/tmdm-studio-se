 ...
 * <ul>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getScript <em>Script</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getTooltip <em>Tooltip</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getWidgetLayoutInfo <em>Widget Layout Info</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getDisplayLabel <em>Display Label</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getShowDisplayLabel <em>Show Display Label</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#isAllowHTMLForDisplayLabel <em>Allow HTML For Display Label</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getHtmlAttributes <em>Html Attributes</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getRealHtmlAttributes <em>Real Html Attributes</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getDependOn <em>Depend On</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#isDisplayDependentWidgetOnlyOnEventTriggered <em>Display Dependent Widget Only On Event Triggered</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getScriptAfterEvent <em>Script After Event</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getParentOf <em>Parent Of</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#isMandatory <em>Mandatory</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getLabelPosition <em>Label Position</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getInputConnectors <em>Input Connectors</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getOutputConnectors <em>Output Connectors</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getAfterEventConnectors <em>After Event Connectors</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#getImgPath <em>Img Path</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.ImageWidgetImpl#isIsAnAttachment <em>Is An Attachment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImageWidgetImpl extends EObjectImpl implements ImageWidget {
    ...
    /**
     * The default value of the '{@link #isIsAnAttachment() <em>Is An Attachment</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @ordered
     */
    protected static final boolean IS_AN_ATTACHMENT_EDEFAULT = false;

    /**
     * The cached value of the '{@link #isIsAnAttachment() <em>Is An Attachment</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isIsAnAttachment()
     * @generated
     * @ordered
     */
    protected boolean isAnAttachment = IS_AN_ATTACHMENT_EDEFAULT;
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__LABEL, oldLabel, label));
    }
    ...
    public NotificationChain basicSetScript(GroovyScript newScript, NotificationChain msgs) {
        ...
        script = newScript;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__SCRIPT, oldScript, newScript);
    ...
    public void setScript(GroovyScript newScript) {
        if (newScript != script) {
            ...
            if (script != null)
                msgs = ((InternalEObject)script).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__SCRIPT, null, msgs);
            if (newScript != null)
                msgs = ((InternalEObject)newScript).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__SCRIPT, null, msgs);
            msgs = basicSetScript(newScript, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__SCRIPT, newScript, newScript));
    }
    ...
    public void setTooltip(String newTooltip) {
        ...
        tooltip = newTooltip;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__TOOLTIP, oldTooltip, tooltip));
    }
    ...
    public void setDisplayLabel(String newDisplayLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
    }
    ...
    public NotificationChain basicSetScriptAfterEvent(GroovyScript newScriptAfterEvent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__SCRIPT_AFTER_EVENT, oldScriptAfterEvent, newScriptAfterEvent);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setScriptAfterEvent(GroovyScript newScriptAfterEvent) {
        if (newScriptAfterEvent != scriptAfterEvent) {
            ...
            if (scriptAfterEvent != null)
                msgs = ((InternalEObject)scriptAfterEvent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__SCRIPT_AFTER_EVENT, null, msgs);
            if (newScriptAfterEvent != null)
                msgs = ((InternalEObject)newScriptAfterEvent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormPackage.IMAGE_WIDGET__SCRIPT_AFTER_EVENT, null, msgs);
            msgs = basicSetScriptAfterEvent(newScriptAfterEvent, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__SCRIPT_AFTER_EVENT, newScriptAfterEvent, newScriptAfterEvent));
    }
    ...
    public EList<Connector> getInputConnectors() {
        if (inputConnectors == null) {
            inputConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, FormPackage.IMAGE_WIDGET__INPUT_CONNECTORS);
        }
    ...
    public EList<Connector> getOutputConnectors() {
        if (outputConnectors == null) {
            outputConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, FormPackage.IMAGE_WIDGET__OUTPUT_CONNECTORS);
        }
    ...
    public EList<Connector> getAfterEventConnectors() {
        if (afterEventConnectors == null) {
            afterEventConnectors = new EObjectContainmentEList<Connector>(Connector.class, this, FormPackage.IMAGE_WIDGET__AFTER_EVENT_CONNECTORS);
        }
    ...
    public void setImgPath(String newImgPath) {
        ...
        imgPath = newImgPath;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__IMG_PATH, oldImgPath, imgPath));
    }
     ...
     * @generated
     */
    public boolean isIsAnAttachment() {
     ...
     * @generated
     */
    public void setIsAnAttachment(boolean newIsAnAttachment) {
        boolean oldIsAnAttachment = isAnAttachment;
        isAnAttachment = newIsAnAttachment;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_WIDGET__IS_AN_ATTACHMENT, oldIsAnAttachment, isAnAttachment));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case FormPackage.IMAGE_WIDGET__SCRIPT:
            ...
            case FormPackage.IMAGE_WIDGET__SCRIPT_AFTER_EVENT:
            ...
            case FormPackage.IMAGE_WIDGET__INPUT_CONNECTORS:
                return ((InternalEList<?>)getInputConnectors()).basicRemove(otherEnd, msgs);
            case FormPackage.IMAGE_WIDGET__OUTPUT_CONNECTORS:
                return ((InternalEList<?>)getOutputConnectors()).basicRemove(otherEnd, msgs);
            case FormPackage.IMAGE_WIDGET__AFTER_EVENT_CONNECTORS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case FormPackage.IMAGE_WIDGET__NAME:
                return getName();
            case FormPackage.IMAGE_WIDGET__LABEL:
                return getLabel();
            case FormPackage.IMAGE_WIDGET__TEXT_ANNOTATION_ATTACHMENT:
            ...
            case FormPackage.IMAGE_WIDGET__IMG_PATH:
                return getImgPath();
            case FormPackage.IMAGE_WIDGET__IS_AN_ATTACHMENT:
                return isIsAnAttachment();
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case FormPackage.IMAGE_WIDGET__IMG_PATH:
                ...
                return;
            case FormPackage.IMAGE_WIDGET__IS_AN_ATTACHMENT:
                setIsAnAttachment((Boolean)newValue);
                return;
        }
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case FormPackage.IMAGE_WIDGET__IMG_PATH:
                ...
                return;
            case FormPackage.IMAGE_WIDGET__IS_AN_ATTACHMENT:
                setIsAnAttachment(IS_AN_ATTACHMENT_EDEFAULT);
                return;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case FormPackage.IMAGE_WIDGET__IS_AN_ATTACHMENT:
                return isAnAttachment != IS_AN_ATTACHMENT_EDEFAULT;
        }
    ...
    public String toString() {
        ...
        result.append(", imgPath: "); //$NON-NLS-1$
        result.append(imgPath);
        result.append(", isAnAttachment: "); //$NON-NLS-1$
        result.append(isAnAttachment);
        result.append(')');
