 ...
 * <ul>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#isDuplicate <em>Duplicate</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#isLimitNumberOfDuplication <em>Limit Number Of Duplication</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#getMaxNumberOfDuplication <em>Max Number Of Duplication</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#isLimitMinNumberOfDuplication <em>Limit Min Number Of Duplication</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#getMinNumberOfDuplication <em>Min Number Of Duplication</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#getDisplayLabelForAdd <em>Display Label For Add</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#getTooltipForAdd <em>Tooltip For Add</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#getDisplayLabelForRemove <em>Display Label For Remove</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#getTooltipForRemove <em>Tooltip For Remove</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#getInitialFormat <em>Initial Format</em>}</li>
 *   <li>{@link org.talend.process.model.form.impl.DateFormFieldImpl#getDisplayFormat <em>Display Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DateFormFieldImpl extends SingleValuatedFormFieldImpl implements DateFormField {
    ...
    public void setDuplicate(boolean newDuplicate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__DUPLICATE, oldDuplicate, duplicate));
    }
    ...
    public void setLimitNumberOfDuplication(boolean newLimitNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__LIMIT_NUMBER_OF_DUPLICATION, oldLimitNumberOfDuplication, limitNumberOfDuplication));
    }
    ...
    public void setMaxNumberOfDuplication(String newMaxNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__MAX_NUMBER_OF_DUPLICATION, oldMaxNumberOfDuplication, maxNumberOfDuplication));
    }
    ...
    public void setLimitMinNumberOfDuplication(boolean newLimitMinNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__LIMIT_MIN_NUMBER_OF_DUPLICATION, oldLimitMinNumberOfDuplication, limitMinNumberOfDuplication));
    }
    ...
    public void setMinNumberOfDuplication(String newMinNumberOfDuplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__MIN_NUMBER_OF_DUPLICATION, oldMinNumberOfDuplication, minNumberOfDuplication));
    }
    ...
    public void setDisplayLabelForAdd(String newDisplayLabelForAdd) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__DISPLAY_LABEL_FOR_ADD, oldDisplayLabelForAdd, displayLabelForAdd));
    }
    ...
    public void setTooltipForAdd(String newTooltipForAdd) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__TOOLTIP_FOR_ADD, oldTooltipForAdd, tooltipForAdd));
    }
    ...
    public void setDisplayLabelForRemove(String newDisplayLabelForRemove) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__DISPLAY_LABEL_FOR_REMOVE, oldDisplayLabelForRemove, displayLabelForRemove));
    }
    ...
    public void setTooltipForRemove(String newTooltipForRemove) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_FORM_FIELD__TOOLTIP_FOR_REMOVE, oldTooltipForRemove, tooltipForRemove));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case FormPackage.DATE_FORM_FIELD__DUPLICATE:
                return isDuplicate();
            case FormPackage.DATE_FORM_FIELD__LIMIT_NUMBER_OF_DUPLICATION:
                return isLimitNumberOfDuplication();
            case FormPackage.DATE_FORM_FIELD__MAX_NUMBER_OF_DUPLICATION:
                return getMaxNumberOfDuplication();
            case FormPackage.DATE_FORM_FIELD__LIMIT_MIN_NUMBER_OF_DUPLICATION:
                return isLimitMinNumberOfDuplication();
            case FormPackage.DATE_FORM_FIELD__MIN_NUMBER_OF_DUPLICATION:
                return getMinNumberOfDuplication();
            case FormPackage.DATE_FORM_FIELD__DISPLAY_LABEL_FOR_ADD:
                return getDisplayLabelForAdd();
            case FormPackage.DATE_FORM_FIELD__TOOLTIP_FOR_ADD:
                return getTooltipForAdd();
            case FormPackage.DATE_FORM_FIELD__DISPLAY_LABEL_FOR_REMOVE:
                return getDisplayLabelForRemove();
            case FormPackage.DATE_FORM_FIELD__TOOLTIP_FOR_REMOVE:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Duplicable.class) {
            switch (derivedFeatureID) {
                case FormPackage.DATE_FORM_FIELD__DUPLICATE: return FormPackage.DUPLICABLE__DUPLICATE;
                case FormPackage.DATE_FORM_FIELD__LIMIT_NUMBER_OF_DUPLICATION: return FormPackage.DUPLICABLE__LIMIT_NUMBER_OF_DUPLICATION;
                case FormPackage.DATE_FORM_FIELD__MAX_NUMBER_OF_DUPLICATION: return FormPackage.DUPLICABLE__MAX_NUMBER_OF_DUPLICATION;
                case FormPackage.DATE_FORM_FIELD__LIMIT_MIN_NUMBER_OF_DUPLICATION: return FormPackage.DUPLICABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DATE_FORM_FIELD__MIN_NUMBER_OF_DUPLICATION: return FormPackage.DUPLICABLE__MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DATE_FORM_FIELD__DISPLAY_LABEL_FOR_ADD: return FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_ADD;
                case FormPackage.DATE_FORM_FIELD__TOOLTIP_FOR_ADD: return FormPackage.DUPLICABLE__TOOLTIP_FOR_ADD;
                case FormPackage.DATE_FORM_FIELD__DISPLAY_LABEL_FOR_REMOVE: return FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_REMOVE;
                case FormPackage.DATE_FORM_FIELD__TOOLTIP_FOR_REMOVE: return FormPackage.DUPLICABLE__TOOLTIP_FOR_REMOVE;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Duplicable.class) {
            switch (baseFeatureID) {
                case FormPackage.DUPLICABLE__DUPLICATE: return FormPackage.DATE_FORM_FIELD__DUPLICATE;
                case FormPackage.DUPLICABLE__LIMIT_NUMBER_OF_DUPLICATION: return FormPackage.DATE_FORM_FIELD__LIMIT_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MAX_NUMBER_OF_DUPLICATION: return FormPackage.DATE_FORM_FIELD__MAX_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__LIMIT_MIN_NUMBER_OF_DUPLICATION: return FormPackage.DATE_FORM_FIELD__LIMIT_MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__MIN_NUMBER_OF_DUPLICATION: return FormPackage.DATE_FORM_FIELD__MIN_NUMBER_OF_DUPLICATION;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_ADD: return FormPackage.DATE_FORM_FIELD__DISPLAY_LABEL_FOR_ADD;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_ADD: return FormPackage.DATE_FORM_FIELD__TOOLTIP_FOR_ADD;
                case FormPackage.DUPLICABLE__DISPLAY_LABEL_FOR_REMOVE: return FormPackage.DATE_FORM_FIELD__DISPLAY_LABEL_FOR_REMOVE;
                case FormPackage.DUPLICABLE__TOOLTIP_FOR_REMOVE: return FormPackage.DATE_FORM_FIELD__TOOLTIP_FOR_REMOVE;
                default: return -1;
            }
        }
