...
public class KpiFactoryImpl extends EFactoryImpl implements KpiFactory {
    ...
    public static KpiFactory init() {
        try {
            KpiFactory theKpiFactory = (KpiFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.bonitasoft.org/ns/studio/kpi"); //$NON-NLS-1$ 
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            ...
            case KpiPackage.DATABASE_CONFIGURATION: return createDatabaseConfiguration();
