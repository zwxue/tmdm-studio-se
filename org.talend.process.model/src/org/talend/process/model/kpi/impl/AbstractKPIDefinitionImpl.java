 ...
 * <ul>
 *   <li>{@link org.talend.process.model.kpi.impl.AbstractKPIDefinitionImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.talend.process.model.kpi.impl.AbstractKPIDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.talend.process.model.kpi.impl.AbstractKPIDefinitionImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.process.model.kpi.impl.AbstractKPIDefinitionImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.talend.process.model.kpi.impl.AbstractKPIDefinitionImpl#getFields <em>Fields</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractKPIDefinitionImpl extends EObjectImpl implements AbstractKPIDefinition {
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KpiPackage.ABSTRACT_KPI_DEFINITION__LABEL, oldLabel, label));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case KpiPackage.ABSTRACT_KPI_DEFINITION__NAME:
                return getName();
            case KpiPackage.ABSTRACT_KPI_DEFINITION__LABEL:
                return getLabel();
            case KpiPackage.ABSTRACT_KPI_DEFINITION__TEXT_ANNOTATION_ATTACHMENT:
