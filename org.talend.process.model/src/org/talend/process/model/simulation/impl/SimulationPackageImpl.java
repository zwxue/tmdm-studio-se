...
import org.talend.process.model.simulation.DayPeriod;
import org.talend.process.model.simulation.InjectionPeriod;
import org.talend.process.model.simulation.LoadProfile;
import org.talend.process.model.simulation.ModelVersion;
import org.talend.process.model.simulation.RepartitionType;
import org.talend.process.model.simulation.Resource;
...
import org.talend.process.model.simulation.SimulationCalendar;
...
import org.talend.process.model.simulation.SimulationElement;
import org.talend.process.model.simulation.SimulationFactory;
...
import org.talend.process.model.simulation.TimeUnit;
...
public class SimulationPackageImpl extends EPackageImpl implements SimulationPackage {
     ...
     * @see org.talend.process.model.simulation.SimulationPackage#eNS_URI
     * @see #init()
     * @generated
     */
     ...
     * @generated
     */
    public EAttribute getSimulationData_Expression() {
    ...
    public EAttribute getSimulationData_ExpressionBased() {
        return (EAttribute)simulationDataEClass.getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public EAttribute getSimulationTransition_Expression() {
    ...
    public EAttribute getSimulationTransition_UseExpression() {
        return (EAttribute)simulationTransitionEClass.getEStructuralFeatures().get(3);
    }
    ...
    public void createPackageContents() {
        ...
        createEAttribute(simulationDataEClass, SIMULATION_DATA__EXPRESSION);
        ...
        createEAttribute(simulationTransitionEClass, SIMULATION_TRANSITION__EXPRESSION);
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getSimulationData_Expression(), ecorePackage.getEString(), "expression", null, 0, 1, SimulationData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        ...
        initEAttribute(getSimulationTransition_Expression(), ecorePackage.getEString(), "expression", null, 0, 1, SimulationTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        ...
        initEAttribute(getInjectionPeriod_Repartition(), this.getRepartitionType(), "repartition", "0", 1, 1, InjectionPeriod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        initEAttribute(getSimulationNumberRange_Probability(), ecorePackage.getEDouble(), "probability", null, 0, 1, SimulationNumberRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        initEAttribute(getSimulationNumberRange_RepartitionType(), this.getRepartitionType(), "repartitionType", "0", 1, 1, SimulationNumberRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        initEAttribute(getDataChange_Value(), ecorePackage.getEString(), "value", null, 0, 1, DataChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        ...
        initEAttribute(getResource_Quantity(), ecorePackage.getEInt(), "quantity", null, 0, 1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
