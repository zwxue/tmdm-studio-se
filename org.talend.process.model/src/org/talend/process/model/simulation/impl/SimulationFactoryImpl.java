...
public class SimulationFactoryImpl extends EFactoryImpl implements SimulationFactory {
    ...
    public static SimulationFactory init() {
        try {
            SimulationFactory theSimulationFactory = (SimulationFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.bonitasoft.org/ns/studio/process/simulation"); //$NON-NLS-1$ 
