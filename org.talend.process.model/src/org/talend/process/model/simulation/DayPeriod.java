 ...
 * <ul>
 *   <li>{@link org.talend.process.model.simulation.DayPeriod#getDay <em>Day</em>}</li>
 *   <li>{@link org.talend.process.model.simulation.DayPeriod#getStartHour <em>Start Hour</em>}</li>
 *   <li>{@link org.talend.process.model.simulation.DayPeriod#getEndHour <em>End Hour</em>}</li>
 *   <li>{@link org.talend.process.model.simulation.DayPeriod#getStartMinute <em>Start Minute</em>}</li>
 *   <li>{@link org.talend.process.model.simulation.DayPeriod#getEndMinute <em>End Minute</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.talend.process.model.simulation.SimulationPackage#getDayPeriod()
 * @model
 * @generated
 */
public interface DayPeriod extends EObject {
     ...
     * @see org.talend.process.model.simulation.SimulationPackage#getDayPeriod_Day()
     * @model
     * @generated
     */
     ...
     * @see org.talend.process.model.simulation.SimulationPackage#getDayPeriod_StartHour()
    ...
    /**
     * Sets the value of the '{@link org.talend.process.model.simulation.DayPeriod#getStartHour <em>Start Hour</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setEndHour(int)
     * @see org.talend.process.model.simulation.SimulationPackage#getDayPeriod_EndHour()
     * @model default="0" required="true"
     * @generated
     */
    int getEndHour();
    ...
    /**
     * Sets the value of the '{@link org.talend.process.model.simulation.DayPeriod#getEndHour <em>End Hour</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see org.talend.process.model.simulation.SimulationPackage#getDayPeriod_StartMinute()
     * @model default="0" required="true"
     * @generated
     */
    int getStartMinute();
    ...
    /**
     * Sets the value of the '{@link org.talend.process.model.simulation.DayPeriod#getStartMinute <em>Start Minute</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see org.talend.process.model.simulation.SimulationPackage#getDayPeriod_EndMinute()
     * @model default="0" required="true"
     * @generated
     */
    int getEndMinute();
    ...
    /**
     * Sets the value of the '{@link org.talend.process.model.simulation.DayPeriod#getEndMinute <em>End Minute</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
