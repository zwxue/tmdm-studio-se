 ...
 * <ul>
 *   <li>{@link org.talend.process.model.process.impl.SendTaskImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.SendTaskImpl#getOutgoingMessages <em>Outgoing Messages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SendTaskImpl extends ActivityImpl implements SendTask {
    ...
    public EList<EventObject> getEvents() {
        if (events == null) {
            events = new EObjectContainmentWithInverseEList<EventObject>(EventObject.class, this, ProcessPackage.SEND_TASK__EVENTS, ProcessPackage.EVENT_OBJECT__SOURCE);
        }
        return events;
    }
