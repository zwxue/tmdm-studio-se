 ...
 * <ul>
 *   <li>{@link org.talend.process.model.process.impl.ConnectableElementImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.ConnectableElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.ConnectableElementImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.ConnectableElementImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.ConnectableElementImpl#getConnectors <em>Connectors</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.ConnectableElementImpl#getData <em>Data</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.ConnectableElementImpl#getKpis <em>Kpis</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectableElementImpl extends EObjectImpl implements ConnectableElement {
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.CONNECTABLE_ELEMENT__LABEL, oldLabel, label));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ProcessPackage.CONNECTABLE_ELEMENT__NAME:
                return getName();
            case ProcessPackage.CONNECTABLE_ELEMENT__LABEL:
                return getLabel();
            case ProcessPackage.CONNECTABLE_ELEMENT__TEXT_ANNOTATION_ATTACHMENT:
