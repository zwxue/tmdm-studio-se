 ...
 * <ul>
 *   <li>{@link org.talend.process.model.process.impl.DataTypeImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.DataTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.DataTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.DataTypeImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DataTypeImpl extends EObjectImpl implements DataType {
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA_TYPE__LABEL, oldLabel, label));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ProcessPackage.DATA_TYPE__NAME:
                return getName();
            case ProcessPackage.DATA_TYPE__LABEL:
                return getLabel();
            case ProcessPackage.DATA_TYPE__TEXT_ANNOTATION_ATTACHMENT:
