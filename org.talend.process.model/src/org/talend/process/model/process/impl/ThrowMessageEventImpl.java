 ...
 * <ul>
 *   <li>{@link org.talend.process.model.process.impl.ThrowMessageEventImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link org.talend.process.model.process.impl.ThrowMessageEventImpl#getOutgoingMessages <em>Outgoing Messages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThrowMessageEventImpl extends MessageEventImpl implements ThrowMessageEvent {
     ...
     * @ordered
     */
    protected EList<EventObject> events;
     ...
     * @generated
     */
    public EList<EventObject> getEvents() {
        if (events == null) {
            events = new EObjectContainmentWithInverseEList<EventObject>(EventObject.class, this, ProcessPackage.THROW_MESSAGE_EVENT__EVENTS, ProcessPackage.EVENT_OBJECT__SOURCE);
        }
        return events;
    }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            case ProcessPackage.THROW_MESSAGE_EVENT__EVENTS:
                getEvents().clear();
                getEvents().addAll((Collection<? extends EventObject>)newValue);
                return;
            case ProcessPackage.THROW_MESSAGE_EVENT__OUTGOING_MESSAGES:
