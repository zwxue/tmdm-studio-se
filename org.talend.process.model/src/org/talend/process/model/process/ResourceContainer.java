 ...
 * <ul>
 *   <li>{@link org.talend.process.model.process.ResourceContainer#getResourceFolders <em>Resource Folders</em>}</li>
 *   <li>{@link org.talend.process.model.process.ResourceContainer#getHtmlTemplate <em>Html Template</em>}</li>
 *   <li>{@link org.talend.process.model.process.ResourceContainer#getResourceFiles <em>Resource Files</em>}</li>
 *   <li>{@link org.talend.process.model.process.ResourceContainer#getResourceJars <em>Resource Jars</em>}</li>
 *   <li>{@link org.talend.process.model.process.ResourceContainer#getResourceValidators <em>Resource Validators</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.talend.process.model.process.ProcessPackage#getResourceContainer()
 * @model
 * @generated
 */
public interface ResourceContainer extends EObject {
     ...
     * The list contents are of type {@link org.talend.process.model.process.ResourceFolder}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.talend.process.model.process.ProcessPackage#getResourceContainer_ResourceFolders()
     ...
     * @see org.talend.process.model.process.ProcessPackage#getResourceContainer_HtmlTemplate()
     * @model containment="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.talend.process.model.process.ResourceContainer#getHtmlTemplate <em>Html Template</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see org.talend.process.model.process.ProcessPackage#getResourceContainer_ResourceFiles()
     * @model containment="true"
     * @generated
     */
     ...
     * @see org.talend.process.model.process.ProcessPackage#getResourceContainer_ResourceJars()
     * @model
     * @generated
     */
     ...
     * @see org.talend.process.model.process.ProcessPackage#getResourceContainer_ResourceValidators()
     * @model
     * @generated
     */
