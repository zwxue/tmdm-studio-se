...
public class BeanClassUtilTest {
    ...
    private void verifyObjectTypeClass(Class<ObjectClass> cls) throws Exception {
        ...
        // verify the certain field's class
        Map<Field, Method[]> menuFieldMap = bClassUtil.findFieldMap(WSMenu.class);
        assertNotNull(menuFieldMap);
        assertTrue(menuFieldMap.size() > 0);
    }
