...
public class RemoteLoggerService_Proxy extends RemoteServiceProxy implements com.allen_sauer.gwt.log.client.RemoteLoggerServiceAsync {
  ...
  public void log(java.util.ArrayList logRecords, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    ...
    boolean toss = isStatsAvailable() && stats(timeStat("RemoteLoggerService_Proxy.log", requestId, "begin"));
    ...
    try {
      ...
      toss = isStatsAvailable() && stats(timeStat("RemoteLoggerService_Proxy.log", requestId, "requestSerialized"));
      doInvoke(ResponseReader.VOID, "RemoteLoggerService_Proxy.log", requestId, payload, callback);
