...
public class ViewCopyTest extends TalendSWTBotForMDM {
	...
	public void viewCopyTest() {
		...
		SWTBotShell pasteviewShell = bot.shell("Pasting instance " + PREFIX
				+ "Conf");
		pasteviewShell.activate();
		bot.text("CopyOf" + PREFIX + "Conf").setText(
				PREFIX + "Conf" + "PasteView");
		bot.button("OK").click();
		SWTBotTreeItem pasteNode = viewParentItem.getNode(PREFIX + "Conf"
				+ "PasteView");
	...
	public void runAfterEveryTest() {
		...
		viewParentItem.getNode(PREFIX + "Conf" + "PasteView")
