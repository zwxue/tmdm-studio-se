...
public class DataModelSchemaElementOperationTest extends DataModelTest {
    ...
    public void setForeignKeyFilterTest() {
        ...
        SWTBotShell shell = bot.shell("Set the Foreign Key Filter");
        shell.activate();
        bot.buttonWithTooltip("Add").click();
        bot.buttonWithTooltip("Select Xpath").click();
    ...
    public void setFacetTest() {
        ...
        sleep();
        SWTBotShell shell = bot.shell("Set multilingual facet error message ...");
        shell.activate();
        bot.comboBox().setSelection(0);
    ...
    public void setDisplayFormatTest() {
        ...
        sleep();
        SWTBotShell shell = bot.shell("Set the display format for the content...");
        shell.activate();
        bot.comboBox().setSelection(0);
