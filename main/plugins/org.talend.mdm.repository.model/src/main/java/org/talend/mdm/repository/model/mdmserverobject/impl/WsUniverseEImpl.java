...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ws Universe E</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsUniverseEImpl#getDefaultItemsRevisionID <em>Default
 * Items Revision ID</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsUniverseEImpl#getXtentisObjectsRevisionIDs <em>
 * Xtentis Objects Revision IDs</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsUniverseEImpl#getItemsRevisionIDs <em>Items
 * Revision IDs</em>}</li>
 * </ul>
 * </p>
 *
...
public class WsUniverseEImpl extends MDMServerObjectImpl implements WsUniverseE {
    ...
    /**
     * The cached value of the '{@link #getXtentisObjectsRevisionIDs() <em>Xtentis Objects Revision IDs</em>}'
    ...
    public void setDefaultItemsRevisionID(String newDefaultItemsRevisionID) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    MdmserverobjectPackage.WS_UNIVERSE_E__DEFAULT_ITEMS_REVISION_ID, oldDefaultItemsRevisionID,
    ...
    public EList<WsUniverseXtentisObjectsRevisionIDsE> getXtentisObjectsRevisionIDs() {
        if (xtentisObjectsRevisionIDs == null) {
            xtentisObjectsRevisionIDs = new EObjectContainmentEList<WsUniverseXtentisObjectsRevisionIDsE>(
                    WsUniverseXtentisObjectsRevisionIDsE.class, this,
                    MdmserverobjectPackage.WS_UNIVERSE_E__XTENTIS_OBJECTS_REVISION_IDS);
        }
    ...
    public EList<WsUniverseItemsRevisionIDsE> getItemsRevisionIDs() {
        if (itemsRevisionIDs == null) {
            itemsRevisionIDs = new EObjectContainmentEList<WsUniverseItemsRevisionIDsE>(WsUniverseItemsRevisionIDsE.class, this,
                    MdmserverobjectPackage.WS_UNIVERSE_E__ITEMS_REVISION_IDS);
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case MdmserverobjectPackage.WS_UNIVERSE_E__DEFAULT_ITEMS_REVISION_ID:
            return DEFAULT_ITEMS_REVISION_ID_EDEFAULT == null ? defaultItemsRevisionID != null
                    : !DEFAULT_ITEMS_REVISION_ID_EDEFAULT.equals(defaultItemsRevisionID);
        case MdmserverobjectPackage.WS_UNIVERSE_E__XTENTIS_OBJECTS_REVISION_IDS:
