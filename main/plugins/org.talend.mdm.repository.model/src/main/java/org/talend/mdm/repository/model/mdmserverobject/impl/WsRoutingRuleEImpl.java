...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ws Routing Rule E</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsRoutingRuleEImpl#isSynchronous <em>Synchronous
 * </em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsRoutingRuleEImpl#getConcept <em>Concept</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsRoutingRuleEImpl#getServiceJNDI <em>Service JNDI
 * </em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsRoutingRuleEImpl#getParameters <em>Parameters</em>}
 * </li>
 ...
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsRoutingRuleEImpl#getExecuteOrder <em>Execute Order
 * </em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsRoutingRuleEImpl#getWsRoutingRuleExpressions <em>Ws
 * Routing Rule Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WsRoutingRuleEImpl extends MDMServerObjectImpl implements WsRoutingRuleE {
    ...
    /**
     * The cached value of the '{@link #isSynchronous() <em>Synchronous</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #isSynchronous()
     * @generated
    ...
    /**
     * The default value of the '{@link #getConcept() <em>Concept</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getConcept()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getConcept() <em>Concept</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getConcept()
     * @generated
    ...
    /**
     * The default value of the '{@link #getServiceJNDI() <em>Service JNDI</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getServiceJNDI()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getServiceJNDI() <em>Service JNDI</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getServiceJNDI()
     * @generated
    ...
    /**
     * The default value of the '{@link #isDeactive() <em>Deactive</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #isDeactive()
     * @generated
    ...
    /**
     * The cached value of the '{@link #isDeactive() <em>Deactive</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #isDeactive()
     * @generated
    ...
    /**
     * The default value of the '{@link #getExecuteOrder() <em>Execute Order</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getExecuteOrder()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getExecuteOrder() <em>Execute Order</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getExecuteOrder()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getWsRoutingRuleExpressions() <em>Ws Routing Rule Expressions</em>}' containment
    ...
    public void setSynchronous(boolean newSynchronous) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_ROUTING_RULE_E__SYNCHRONOUS,
    ...
    public void setConcept(String newConcept) {
        ...
        concept = newConcept;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_ROUTING_RULE_E__CONCEPT, oldConcept,
                    concept));
        }
    }
    ...
    public void setServiceJNDI(String newServiceJNDI) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_ROUTING_RULE_E__SERVICE_JNDI,
                    oldServiceJNDI, serviceJNDI));
        }
    }
    ...
    public void setParameters(String newParameters) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_ROUTING_RULE_E__PARAMETERS,
    ...
    public void setCondition(String newCondition) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_ROUTING_RULE_E__CONDITION,
    ...
    public void setDeactive(boolean newDeactive) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_ROUTING_RULE_E__DEACTIVE,
                    oldDeactive, deactive));
        }
    }
    ...
    public void setExecuteOrder(int newExecuteOrder) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_ROUTING_RULE_E__EXECUTE_ORDER,
                    oldExecuteOrder, executeOrder));
        }
    }
    ...
    public EList<WsRoutingRuleExpressionE> getWsRoutingRuleExpressions() {
        if (wsRoutingRuleExpressions == null) {
            wsRoutingRuleExpressions = new EObjectContainmentEList<WsRoutingRuleExpressionE>(WsRoutingRuleExpressionE.class,
                    this, MdmserverobjectPackage.WS_ROUTING_RULE_E__WS_ROUTING_RULE_EXPRESSIONS);
        }
