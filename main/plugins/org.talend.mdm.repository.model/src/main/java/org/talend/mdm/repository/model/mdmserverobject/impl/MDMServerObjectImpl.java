 ...
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.MDMServerObjectImpl#getTimestamp <em>Timestamp</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.MDMServerObjectImpl#getDigestValue <em>Digest Value
 * </em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.MDMServerObjectImpl#getCurrentDigestValue <em>Current
 * Digest Value</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.MDMServerObjectImpl#getLastServerName <em>Last Server
 * Name</em>}</li>
 * </ul>
 * </p>
 *
...
public class MDMServerObjectImpl extends EObjectImpl implements MDMServerObject {
    ...
    /**
     * The default value of the '{@link #getDigestValue() <em>Digest Value</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getDigestValue()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getDigestValue() <em>Digest Value</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getDigestValue()
     * @generated
    ...
    /**
     * The default value of the '{@link #getLastServerName() <em>Last Server Name</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getLastServerName() <em>Last Server Name</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @see #getLastServerName()
     * @generated
    ...
    public void setTimestamp(long newTimestamp) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.MDM_SERVER_OBJECT__TIMESTAMP,
    ...
    public void setDigestValue(String newDigestValue) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.MDM_SERVER_OBJECT__DIGEST_VALUE,
                    oldDigestValue, digestValue));
        }
    }
    ...
    public void setCurrentDigestValue(String newCurrentDigestValue) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.MDM_SERVER_OBJECT__CURRENT_DIGEST_VALUE,
                    oldCurrentDigestValue, currentDigestValue));
        }
    }
    ...
    public void setLastServerName(String newLastServerName) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.MDM_SERVER_OBJECT__LAST_SERVER_NAME,
                    oldLastServerName, lastServerName));
        }
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case MdmserverobjectPackage.MDM_SERVER_OBJECT__CURRENT_DIGEST_VALUE:
            return CURRENT_DIGEST_VALUE_EDEFAULT == null ? currentDigestValue != null : !CURRENT_DIGEST_VALUE_EDEFAULT
                    .equals(currentDigestValue);
        case MdmserverobjectPackage.MDM_SERVER_OBJECT__LAST_SERVER_NAME:
