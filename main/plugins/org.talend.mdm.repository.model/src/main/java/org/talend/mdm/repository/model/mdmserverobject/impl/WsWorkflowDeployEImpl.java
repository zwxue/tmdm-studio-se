...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ws Workflow Deploy E</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class WsWorkflowDeployEImpl extends MDMServerObjectImpl implements WsWorkflowDeployE {
    ...
    public void setFilename(String newFilename) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_WORKFLOW_DEPLOY_E__FILENAME,
