...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ws Stored Procedure E</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsStoredProcedureEImpl#getProcedure <em>Procedure
 * </em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsStoredProcedureEImpl#isRefreshCache <em>Refresh
 * Cache</em>}</li>
 * </ul>
 * </p>
 *
...
public class WsStoredProcedureEImpl extends MDMServerObjectImpl implements WsStoredProcedureE {
    ...
    /**
     * The default value of the '{@link #getProcedure() <em>Procedure</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getProcedure()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getProcedure() <em>Procedure</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getProcedure()
     * @generated
    ...
    /**
     * The default value of the '{@link #isRefreshCache() <em>Refresh Cache</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #isRefreshCache()
     * @generated
    ...
    /**
     * The cached value of the '{@link #isRefreshCache() <em>Refresh Cache</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #isRefreshCache()
     * @generated
    ...
    public void setProcedure(String newProcedure) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_STORED_PROCEDURE_E__PROCEDURE,
    ...
    public void setRefreshCache(boolean newRefreshCache) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_STORED_PROCEDURE_E__REFRESH_CACHE,
                    oldRefreshCache, refreshCache));
        }
    }
