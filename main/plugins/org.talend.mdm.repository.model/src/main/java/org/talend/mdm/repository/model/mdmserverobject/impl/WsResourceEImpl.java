 ...
 * <ul>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsResourceEImpl#getFileExtension <em>File Extension
 * </em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsResourceEImpl#getFileContent <em>File Content</em>}
 * </li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsResourceEImpl#getImageCatalog <em>Image Catalog
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class WsResourceEImpl extends MDMServerObjectImpl implements WsResourceE {
    ...
    /**
     * The default value of the '{@link #getImageCatalog() <em>Image Catalog</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getImageCatalog()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getImageCatalog() <em>Image Catalog</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getImageCatalog()
     * @generated
    ...
    public void setFileExtension(String newFileExtension) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_RESOURCE_E__FILE_EXTENSION,
    ...
    public void setFileContent(byte[] newFileContent) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_RESOURCE_E__FILE_CONTENT,
    ...
    public void setImageCatalog(String newImageCatalog) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_RESOURCE_E__IMAGE_CATALOG,
                    oldImageCatalog, imageCatalog));
        }
    }
