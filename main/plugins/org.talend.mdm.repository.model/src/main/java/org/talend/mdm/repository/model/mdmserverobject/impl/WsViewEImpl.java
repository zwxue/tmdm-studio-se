...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ws View E</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsViewEImpl#getSearchableBusinessElements <em>
 * Searchable Business Elements</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsViewEImpl#getViewableBusinessElements <em>Viewable
 * Business Elements</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsViewEImpl#isTransformerActive <em>Transformer
 * Active</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsViewEImpl#getWhereConditions <em>Where Conditions
 * </em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsViewEImpl#getIsTransformerActive <em>Is Transformer
 * Active</em>}</li>
 * <li>{@link org.talend.mdm.repository.model.mdmserverobject.impl.WsViewEImpl#getTransformerPK <em>Transformer PK</em>}
 * </li>
 * </ul>
 * </p>
 *
...
public class WsViewEImpl extends MDMServerObjectImpl implements WsViewE {
    ...
    /**
     * The cached value of the '{@link #getSearchableBusinessElements() <em>Searchable Business Elements</em>}'
    ...
    /**
     * The default value of the '{@link #getTransformerPK() <em>Transformer PK</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getTransformerPK() <em>Transformer PK</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getTransformerPK()
     * @generated
    ...
    public EList<String> getSearchableBusinessElements() {
        if (searchableBusinessElements == null) {
            searchableBusinessElements = new EDataTypeUniqueEList<String>(String.class, this,
                    MdmserverobjectPackage.WS_VIEW_E__SEARCHABLE_BUSINESS_ELEMENTS);
        }
    ...
    public EList<String> getViewableBusinessElements() {
        if (viewableBusinessElements == null) {
            viewableBusinessElements = new EDataTypeUniqueEList<String>(String.class, this,
                    MdmserverobjectPackage.WS_VIEW_E__VIEWABLE_BUSINESS_ELEMENTS);
        }
    ...
    public void setTransformerActive(boolean newTransformerActive) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_VIEW_E__TRANSFORMER_ACTIVE,
                    oldTransformerActive, transformerActive));
        }
    }
    ...
    public EList<WsWhereConditionE> getWhereConditions() {
        if (whereConditions == null) {
            whereConditions = new EObjectContainmentEList<WsWhereConditionE>(WsWhereConditionE.class, this,
                    MdmserverobjectPackage.WS_VIEW_E__WHERE_CONDITIONS);
        }
    ...
    public NotificationChain basicSetIsTransformerActive(WsBooleanE newIsTransformerActive, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    MdmserverobjectPackage.WS_VIEW_E__IS_TRANSFORMER_ACTIVE, oldIsTransformerActive, newIsTransformerActive);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setIsTransformerActive(WsBooleanE newIsTransformerActive) {
        if (newIsTransformerActive != isTransformerActive) {
            ...
            if (isTransformerActive != null) {
                msgs = ((InternalEObject) isTransformerActive).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - MdmserverobjectPackage.WS_VIEW_E__IS_TRANSFORMER_ACTIVE, null, msgs);
            }
            if (newIsTransformerActive != null) {
                msgs = ((InternalEObject) newIsTransformerActive).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - MdmserverobjectPackage.WS_VIEW_E__IS_TRANSFORMER_ACTIVE, null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_VIEW_E__IS_TRANSFORMER_ACTIVE,
                    newIsTransformerActive, newIsTransformerActive));
        }
    }
    ...
    public void setTransformerPK(String newTransformerPK) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_VIEW_E__TRANSFORMER_PK,
                    oldTransformerPK, transformerPK));
        }
    }
