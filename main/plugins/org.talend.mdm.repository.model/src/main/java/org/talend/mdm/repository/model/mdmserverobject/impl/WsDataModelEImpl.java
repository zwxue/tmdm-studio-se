...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ws Data Model E</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class WsDataModelEImpl extends MDMServerObjectImpl implements WsDataModelE {
    ...
    /**
     * The default value of the '{@link #getXsdSchema() <em>Xsd Schema</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getXsdSchema()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getXsdSchema() <em>Xsd Schema</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getXsdSchema()
     * @generated
    ...
    public void setXsdSchema(String newXsdSchema) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_DATA_MODEL_E__XSD_SCHEMA,
                    oldXsdSchema, xsdSchema));
        }
    }
