...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ws Custom Form E</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class WsCustomFormEImpl extends MDMServerObjectImpl implements WsCustomFormE {
    ...
    /**
     * The default value of the '{@link #getFilename() <em>Filename</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getFilename()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getFilename() <em>Filename</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getFilename()
     * @generated
    ...
    /**
     * The default value of the '{@link #getDatamodel() <em>Datamodel</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getDatamodel()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getDatamodel() <em>Datamodel</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getDatamodel()
     * @generated
    ...
    /**
     * The default value of the '{@link #getXml() <em>Xml</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getXml()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getXml() <em>Xml</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getXml()
     * @generated
     * @ordered
    ...
    public void setFilename(String newFilename) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_CUSTOM_FORM_E__FILENAME, oldFilename,
                    filename));
        }
    }
    ...
    public void setDatamodel(String newDatamodel) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_CUSTOM_FORM_E__DATAMODEL,
    ...
    public void setEntity(String newEntity) {
        ...
        entity = newEntity;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, MdmserverobjectPackage.WS_CUSTOM_FORM_E__ENTITY, oldEntity,
                    entity));
        }
    }
