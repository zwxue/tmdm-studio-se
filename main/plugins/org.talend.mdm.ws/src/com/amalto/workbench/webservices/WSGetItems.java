...
public class WSGetItems {
     ...
     * 
     */
    public WSGetItems(final WSDataClusterPK wsDataClusterPK, final String conceptName, final WSWhereItem whereItem, final int spellTreshold, final int skip, final int maxItems, final Boolean totalCountOnFirstResult) {
