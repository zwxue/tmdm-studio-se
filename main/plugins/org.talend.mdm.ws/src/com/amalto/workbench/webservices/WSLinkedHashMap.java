...
public class WSLinkedHashMap {
     ...
     * 
     */
    public WSLinkedHashMap(final List<WSLinkedHashMap.TypedContentEntry> typedContentEntry) {
    ...
    public static class TypedContentEntry {
         ...
         * 
         */
        public TypedContentEntry(final String key, final WSStringArray value) {
            this.key = key;
            this.value = value;
        }
