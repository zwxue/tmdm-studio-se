...
public class WSTypedContentMap {
     ...
     * 
     */
    public WSTypedContentMap(final List<WSTypedContentMap.MapEntry> mapEntry) {
    ...
    public static class MapEntry {
         ...
         * 
         */
        public MapEntry(final String key, final WSTypedContent typedContent) {
            this.key = key;
