...
public class WSRoutingOrderV2SearchCriteriaWithPaging {
     ...
     * 
     */
    public WSRoutingOrderV2SearchCriteriaWithPaging(final WSRoutingOrderV2Status status, final String anyFieldContains, final String nameContains, final long timeCreatedMin, final long timeCreatedMax, final long timeScheduledMin, final long timeScheduledMax, final long timeLastRunStartedMin, final long timeLastRunStartedMax, final long timeLastRunCompletedMin, final long timeLastRunCompletedMax, final String itemPKConceptContains, final String itemPKIDFieldsContain, final String serviceJNDIContains, final String serviceParametersContain, final String messageContain, final int skip, final int maxItems, final Boolean totalCountOnFirstResult) {
        this.status = status;
