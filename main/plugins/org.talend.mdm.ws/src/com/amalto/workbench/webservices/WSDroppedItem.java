...
public class WSDroppedItem {
     ...
     * 
     */
    public WSDroppedItem(final String revisionID, final WSDataClusterPK wsDataClusterPK, final String uniqueId, final String conceptName, final List<String> ids, final String partPath, final String insertionUserName, final Long insertionTime, final String projection) {
