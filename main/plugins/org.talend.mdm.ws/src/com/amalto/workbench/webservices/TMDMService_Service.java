 ...
 * 2015-02-12T12:23:43.829+08:00
 * Generated source version: 2.6.15
 * 
 */
@WebServiceClient(name = "TMDMService", 
                  wsdlLocation = "file:/d:/workspace/workplaceB/studio/tmdm-studio-se/main/plugins/org.talend.mdm.ws/webservices.wsdl",
...
public class TMDMService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/d:/workspace/workplaceB/studio/tmdm-studio-se/main/plugins/org.talend.mdm.ws/webservices.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TMDMService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/d:/workspace/workplaceB/studio/tmdm-studio-se/main/plugins/org.talend.mdm.ws/webservices.wsdl");
        }
        WSDL_LOCATION = url;
    }
