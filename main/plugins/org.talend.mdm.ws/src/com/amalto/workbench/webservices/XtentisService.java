...
@WebServiceClient(name = "XtentisService", 
                  wsdlLocation = "file:/E:/W/t2/tom/org.talend.mdm.core.open/src/META-INF/wsdl/webservices.wsdl",
...
public class XtentisService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/W/t2/tom/org.talend.mdm.core.open/src/META-INF/wsdl/webservices.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/E:/W/t2/tom/org.talend.mdm.core.open/src/META-INF/wsdl/webservices.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
