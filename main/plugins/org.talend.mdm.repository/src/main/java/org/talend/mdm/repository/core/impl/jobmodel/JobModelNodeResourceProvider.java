 ...
 * 
 */
public class JobModelNodeResourceProvider extends AbstractRepositoryNodeResourceProvider {

    public ERepositoryObjectType getRepositoryObjectType(Item item) {
        if (item instanceof WSJobModelItem || item instanceof ContainerItem) {
            return IServerObjectRepositoryType.TYPE_JOBMODEL;
        }
        return null;
    }
    ...
    public boolean canHandleRepObjType(ERepositoryObjectType type) {
        return type == IServerObjectRepositoryType.TYPE_JOBMODEL;
    }
