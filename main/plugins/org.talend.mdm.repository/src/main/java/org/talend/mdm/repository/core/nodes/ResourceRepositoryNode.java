 ...
 * 
 */
public class ResourceRepositoryNode extends RepositoryNodeAdapter {

    public ResourceRepositoryNode() {
        super(ServerObjectImage.RESOURCE_ICON, IServerObjectOrdinal.RESOURCE);
    }
}
