 ...
 */
@Deprecated
public class RepositoryViewObjectCheckedWidget2 extends Composite {
     ...
     * @param style
     */
    public RepositoryViewObjectCheckedWidget2(Composite parent, Object input, Set<IRepositoryViewObject> changeds) {
