 ...
 * 
 */
public class CustomFormRepositoryNode extends RepositoryNodeAdapter {

    public CustomFormRepositoryNode() {
        super(ServerObjectImage.CUSTOMFORM_ICON, IServerObjectOrdinal.CUSTOM_FORM);
    }
}
