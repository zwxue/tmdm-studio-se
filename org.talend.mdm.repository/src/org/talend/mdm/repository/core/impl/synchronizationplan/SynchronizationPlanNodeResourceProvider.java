 ...
 * 
 */
public class SynchronizationPlanNodeResourceProvider extends AbstractRepositoryNodeResourceProvider {

    public ERepositoryObjectType getRepositoryObjectType(Item item) {
        if (item instanceof WSSynchronizationPlanItem || item instanceof ContainerItem) {
    ...
    public Resource create(IProject project, Item item, int classifierID, IPath path) throws PersistenceException {
        ...
        if (repositoryType != null) {
            ...
            contents.add(((WSSynchronizationPlanItem) item).getWsSynchronizationPlan());
            return itemResource;
        }
        return null;
    }
    ...
    public Resource save(Item item) throws PersistenceException {
        if (item instanceof WSSynchronizationPlanItem) {
            Resource resource = xmiResourceManager.getItemResource(item);
            resource.getContents().clear();
            resource.getContents().add(((WSSynchronizationPlanItem) item).getWsSynchronizationPlan());
            Resource eResource = ((WSSynchronizationPlanItem) item).getWsSynchronizationPlan().eResource();
            return resource;
        }
        return null;
    }
    ...
    public Item createNewItem(ERepositoryObjectType type) {
        return MdmpropertiesFactory.eINSTANCE.createWSSynchronizationPlanItem();
    }

    public boolean canHandleRepObjType(ERepositoryObjectType type) {
        return type == IServerObjectRepositoryType.TYPE_SYNCHRONIZATIONPLAN;
    }
