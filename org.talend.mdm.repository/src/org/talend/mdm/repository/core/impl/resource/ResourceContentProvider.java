 ...
 * 
 */
public class ResourceContentProvider extends AbstractContentProvider {

    protected List<IRepositoryViewObject> getViewObjFromSystemFolder(Item parentItem) {
        return RepositoryResourceUtil.findViewObjectsByType(IServerObjectRepositoryType.TYPE_RESOURCE, parentItem,
                TreeObject.RESOURCES);
    }
