 ...
 */
public class XSDPhysicalDeleteAccessActionR extends XSDPhysicalDeleteAccessAction {

    /**
     * DOC hbhong XSDPhysicalDeleteAccessActionR constructor comment.
     * 
     * @param page
     * @param dataModelName
     */
    public XSDPhysicalDeleteAccessActionR(DataModelMainPage page, String dataModelName) {
    ...
    protected AnnotationOrderedListsDialog getNewAnnotaionOrderedListsDialog(Collection<String> values) {
        ...
        }, page.getSite().getShell(), Messages.XSDPhysicalDeleteAccessActionR_title, Messages.XSDSetAnnotationRoles, page,
