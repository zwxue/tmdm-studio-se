 ...
 * 
 */
public class WorkflowDeployRepositoryNode extends RepositoryNodeAdapter {

    public WorkflowDeployRepositoryNode() {
        super(ServerObjectImage.WORKFLOW_ICON, IServerObjectOrdinal.WORKFLOW_PROCESS);
    }
}
